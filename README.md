...
> **212 wissenschaftliche Arbeiten** von Stephan Epp · Stand: Juni 2026
...
| sternfarben | Sternfarben und Schwarzkörperstrahlung — Plancksche Strahlungsformel, Wien'sches Verschiebungsgesetz (λ_max · T = b), Stefan-Boltzmann-Gesetz (j* = σT⁴), Harvard-Spektralklassifikation (O–M), HR-Diagramm; Subgraph-Algorithmus zur Sternhaufen-Klassifikation — Kroupa-IMF, Farb-Häufigkeits-Antikorrelation, Farbindex-Alters-Monotonie; 39 Seiten, 12 Plots |
