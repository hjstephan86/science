...
bindende Einschränkung â€” die Piloten können das volle Lastvielfache
...
\begin{figure}[H]
  ...
  \caption{Dynamische Stabilitätsanalyse.
           ...
           Unten rechts: Dutch-Roll Stabilität â€” $\zeta_{DR}\,\omega_{DR} \geq 0{,}35\;\text{rad/s}$
...
\begin{figure}[H]
  ...
  \caption{Aufklärungsleistung des \SR{}.
           ...
           erzielt.
           Rechts: Payload-Reichweiten-Kompromiss â€” erhöhte Sensorlast reduziert
...
\begin{table}[H]
\centering
\caption{Leistungszusammenfassung \SR{} â€” formal nachgewiesene Kenngrößen}
\label{tab:summary}
\begin{tabular}{lcc}
\toprule
