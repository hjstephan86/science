...
Positivität von $K_{\text{eff}}$ und $\alpha_T$.
\end{proof}
...
erhält man~\eqref{eq:posfehlerbound}.
\end{proof}
...
Druckamplitude gilt, ist die Bedingung stets erfüllt.
\end{proof}
...
sich~\eqref{eq:eulerstab} für den ungünstigsten Fall $P \to P_{\max}$.
\end{proof}
