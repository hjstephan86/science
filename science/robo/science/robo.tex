...
Elastizitätsarbeit von Stephan Epp \cite{hydr2024} -- formal und
...
Die Arbeit von Stephan Epp zur Elastizität hydraulischer Öle~\cite{hydr2024}
...
($\kappa = 3{,}1$) nach Epp~\cite{hydr2024} ergibt:
\begin{equation}
...
(Epp~\cite{iono2024}) und der hydraulischen Elastizitätsoptimierung
(Epp~\cite{hydr2024}) -- aufbaut. Die wesentlichen Ergebnisse gliedern
