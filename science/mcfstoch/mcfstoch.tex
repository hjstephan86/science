...
\begin{itemize}
	\item Abschnitt~\ref{sec:fundamentals} führt fundamentale Konzepte und Definitionen ein.
	\item Abschnitt~\ref{sec:deterministic} analysiert den deterministischen Fall im Detail, mit expliziter Lösung für Kugeln.
	\item Abschnitt~\ref{sec:stochastic} entwickelt die stochastische Theorie und Existenzergebnisse.
	\item Abschnitt~\ref{sec:energy} präsentiert Energieabschätzungen und Dissipationseigenschaften.
	\item Abschnitt~\ref{sec:numerics} bietet numerische Simulationen und Visualisierungen.
	\item Abschnitt~\ref{sec:outlook} diskutiert zukünftige Richtungen und offene Probleme.
\end{itemize}
...
\subsection{Abbildung 1: Deterministischer Mittlerer Krümmungsfluss für Kugeln}
...
\subsection{Abbildung 2: Stochastische Trajektorien mit Rauschstörung}
...
\subsection{Abbildung 3: Level-Set-Formulierung und Radiusevolution}
...
\subsection{Abbildung 4: Ensemble-Statistik aus 500 Trajektorien}
...
\subsection{Abbildung 5: Phasendiagramm (Rauschstärke vs. Auslöschungszeit)}
...
\subsection{Abbildung 6: Energiedissipation und Krümmungsdivergenz}
...
\subsection{Zusammenfassung der Figurenanalyse}

Die sechs Abbildungen zusammen erzählen eine kohärente Geschichte der deterministischen und stochastischen Evolution von Kugeln unter Mittleren Krümmungsfluss:

\begin{enumerate}
	\item \textbf{Abbildung 1} zeigt die fundamentale deterministische Dynamik: Alle Kugeln schrumpfen zu Singularitäten.
	
	\item \textbf{Abbildung 2} demonstriert, dass Rauschen diese Dynamik modifiziert, indem es Pfad-zu-Pfad-Variabilität erzeugt.
	
	\item \textbf{Abbildung 3} visualisiert die Level-Set-Struktur und bestätigt die Erhaltung der Symmetrie.
	
	\item \textbf{Abbildung 4} quantifiziert die stochastische Variabilität durch Ensemble-Statistik und zeigt, dass der Erwartungswert der deterministischen Lösung nahe bleibt, aber mit wachsendem Fehler über Zeit.
	
	\item \textbf{Abbildung 5} offenbart einen kontraintuitiven Effekt: Rauschen beschleunigt die durchschnittliche Singularitätsbildung.
	
	\item \textbf{Abbildung 6} illustriert die Energiedissipation und Krümmungsdivergenz, die die mathematischen Kerneigenschaften des MCF unterstreichen.
\end{enumerate}
...
\bibitem{Epp2026} Epp, S. (2026). Der Subgraph-Algorithmus. \url{https://github.com/hjstephan86/subgraph}.
