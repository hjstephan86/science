...
\begin{proof}
    ...
    $\mu_e \geq \mu_h$, was in Boomphasen der Auslandszelle erfüllt ist. \qed
\end{proof}
...
\begin{proof}
    ...
    auch vollständige Fusion ($c=1$) sind suboptimal. \qed
\end{proof}
...
\begin{proof}
    ...
    \]
    Da $|\mathcal{E}_+(t)| \geq 0$ per Konstruktion, ist die Ungleichung bewiesen. \qed
\end{proof}
...
\begin{proof}
    ...
    mit $\Delta V(t) = 0$ nur wenn $W(t) = W^*$. \qed
\end{proof}
...
\begin{proof}
    ...
    in endlicher Zeit garantiert. \qed
\end{proof}
...
\begin{proof}
    ...
    (Pareto-Optimum liegt in der Stabilitätszone), woraus $\varrho(\Lambda^*) < 1$ folgt. \qed
\end{proof}
...
\begin{proof}
    ...
    $\mathbb{E}[h_{\mathcal{S}}(t)] \geq \mathbb{E}[h_0(t)]$. \qed
\end{proof}
...
\begin{proof}
    ...
    Subgraph-Algorithmus). Insgesamt ergibt sich $O(N^2) + O(N^3) = O(N^3)$. \qed
\end{proof}
...
\begin{proof}
    ...
    Prozesses auf dem kompakten Intervall $(0,1)$ (Feller-Kriterium). \qed
\end{proof}
...
\begin{proof}
    ...
    Asymptotische Stabilität erfordert strikte Ungleichung. \qed
\end{proof}
...
\begin{proof}
    ...
    daher $e(t) \leq \frac{L^*}{\delta_0\kappa - L^*}$. \qed
\end{proof}
...
\begin{proof}
    ...
    \]
    Da $f''(\delta_0^*) > 0$, ist dies ein globales Minimum. \qed
\end{proof}
...
\newblock \emph{Technischer Bericht}, Universität Bielefeld.
\newblock \url{https://gitlab.com/epp-group/}
