...
Verbund vollständige wissenschaftliche Arbeitsabläufe ermöglichen â€“
...
% ==============================================================
\section{NumPy â€“ Das Fundament des Scientific Computing}
\label{sec:numpy}
% ==============================================================
...
Der Kern von NumPy â€“ das N-dimensionale Array \texttt{ndarray} â€“ ist in
...
% ==============================================================
\section{SciPy â€“ Höhere Algorithmen für die Wissenschaft}
\label{sec:scipy}
% ==============================================================
...
sind in C, Fortran oder C++ implementiert â€“ mit Python-Schnittstelle.
...
% ==============================================================
\section{Matplotlib â€“ Wissenschaftliche Visualisierung}
...
Die Anwendungsbeispiele â€“ vom Lorenz-Attraktor über die spektrale PDE-Lösung
bis hin zu statistischen Tests und Signalfiltern â€“ belegen eindrücklich, dass
...
optimale Hardwareeinheit verteilt â€“ CPU-Kerne für seriell-sequentielle
...
\begin{enumerate}
  \item \textbf{Automatische Differentiation (\texttt{jax.grad})}: Jede
    ...
    werden â€“ sowohl Vorwärts- als auch Rückwärtsmodus. Dies ermöglicht
...
Bibliotheken â€“ NumPy, CuPy, JAX, PyTorch, TensorFlow, Dask, cuDF â€“
...
\begin{description}
  ...
  \item[\textbf{WebAssembly / Pyodide}] transportiert den gesamten
    Scientific-Python-Stack â€“ einschließlich NumPy, SciPy und Matplotlib
    â€“ direkt in den Webbrowser. Bildungsinstitutionen berichten bereits
...
\begin{itemize}
  \item \textbf{Sparse Identification of Nonlinear Dynamics (SINDy)}:
    ...
    Messdaten automatisch die dominanten Terme eines DGL-Systems â€“
...
Die Ära des \emph{Exascale-Computing} â€“ mit Systemen, die mehr als
$10^{18}$ Gleitkommaoperationen pro Sekunde ausführen â€“ stellt das
...
\begin{itemize}
  ...
  \item \textbf{PETSc / SLEPc Python-Interfaces}: Über \texttt{petsc4py}
    ...
    und Eigenwertprobleme aus Python nutzbar â€“ mit NumPy-Arrays als
...
seiner Kernalgorithmen einführt â€“ verteilte FFTs (basierend auf
...
Matplotlib vor mehr als zwei Jahrzehnten etabliert haben â€“ das
...
Jede neue Bibliothek â€“ ob JAX, CuPy, Dask oder PyTorch â€“ definiert ihre
...
E. Hairer, S.~P. NÃ¸rsett und G. Wanner.
