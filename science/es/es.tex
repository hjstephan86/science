...
Der EDF$^+$-Algorithmus~\cite{epp2026edf} (Earliest Deadline First,
...
Im Kontext der VADIS-Architektur~\cite{epp2026vadis} k\"{o}nnte der
...
Die Signatur-Chiffre~\cite{epp2026signatur} -- ein post-quanten-sicheres
...
\newblock Technischer Bericht, GitHub,
  \url{https://github.com/hjstephan86/science}, 2026.

\bibitem{pareto1896cours}
V.\ Pareto.
\newblock \emph{Cours d'̩conomie politique}.
...
\newblock Technischer Bericht, GitHub,
  \url{https://github.com/hjstephan86/science/tree/main/science/}, 2024.
