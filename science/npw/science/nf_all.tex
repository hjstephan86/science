...
% Rückpfeil: ljap und sensor liegen auf x=0  â†’ senkrecht nach oben
\draw[arr] (ljap.north)   -- (sensor.south);

% Plastizitäts-Rückkopplung: stp â†’ oben â†’ rechts â†’ markov (L-förmig, gestrichelt)
\draw[arr,dashed]
  (stp.north) -- ++(0,0.85)
...
\bibitem{AlbertBarabasi02} R. Albert and A.-L. BarabÃ¡si,
  ``Statistical mechanics of complex networks,''
  \textit{Rev. Mod. Phys.}, vol.~74, no.~1, pp.~47--97, 2002.

\bibitem{BarabasiOltvai04} A.-L. BarabÃ¡si and Z.\,N. Oltvai,
  ``Network biology: Understanding the cell's functional organization,''
  \textit{Nat. Rev. Genet.}, vol.~5, no.~2, pp.~101--113, 2004.

\bibitem{Jeong00} H. Jeong, B. Tombor, R. Albert, Z.\,N. Oltvai,
  and A.-L. BarabÃ¡si, ``The large-scale organization of metabolic networks,''
