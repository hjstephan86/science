...
\small \texttt{https://github.com/hjstephan86/science/tree/main/science/}}
\date{21. Mai 2026}
...
\begin{enumerate}
    ...
    \item Verbindung der DOCSIS-DomÃ¤ne mit modernen Methoden aus Machine Learning,
...
\begin{definition}[DualPI2-AQM]
    ...
    \begin{itemize}
        \item Klassik-Warteschlange $\mathcal{Q}_C$ mit PI$^2$-Regler:
              ...
              WarteschlangenlÃ¤nge vom Referenzwert ist.
...
\begin{proof}
    Die Transportlatenz setzt sich zusammen aus AusbreitungsverzÃ¶gerung
...
\begin{figure}[h!]
    ...
    \caption{%
        ...
        \textit{(b)}~ZuverlÃ¤ssigkeits-Latenz-Kurven: LLD-DOCSIS~4.0 (blau)
...
\begin{satz}[Netzwerkeffekt-Schwelle f\"{u}r L4S]
    ...
    Systemnutzen (Metcalfe-Gesetz f\"{u}r bilateral komplementÃ¤re Technologien).
\end{satz}
...
\begin{figure}[h!]
    ...
    \caption{%
        ...
        (Q1-2025), T-Mobile-L4S-AnkÃ¼ndigung (Q3-2025), Apple iOS~18.x-Integration
...
\textbf{KanalÃ¼bergreifendes Grant-Sharing in OFDMA.}
...
Control-Barrier-Functions (CBFs) als SicherheitshÃ¼lle um den RL-Agenten --
...
\emph{adaptive Parameteranpassung} erforderlich. ModellprÃ¤diktive Regelung
(MPC) und Adaptive Control Theory bieten hier einen robusten Rahmen, der
die formalen StabilitÃ¤tsgarantien des PI$^2$-Reglers (Lyapunov-Stabilit\"{a}t
...
(Interferenzkanal-KapazitÃ¤t nach Shannon) ist eine offene Forschungsaufgabe.
...
Die Nutzung von DOCSIS-RSU (Road Side Unit) als stationÃ¤rem Ankerpunkt
...
Nettobilanz des CO$_2$-FuÃŸabdrucks von LLD-Netzen -- unter Ber\"{u}cksichtigung
