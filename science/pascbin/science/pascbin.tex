...
Im FPGA-Kontext (relevant für das EHAE-Projekt \cite{epp2024ehae})
...
Im Kontext des PyLab-Frameworks \cite{epp2024pylab} für ESP32 mit
...
\cite{epp2024dna} werden Binomialkoeffizienten benötigt, um die
...
Im Rahmen von AUTOSAR-kompatiblen Steuergeräten \cite{epp2024autosar}
...
Das PyLab-Framework \cite{epp2024pylab} für modellbasierte Regelungstechnik
...
\cite{epp2024biofalcon}) und Spline-basierte Steuerungskurven in PyLab
...
\begin{itemize}
  ...
  \item \textbf{Content-Addressable Storage}: Die Tabelle wird als
        VADIS-kompatible \cite{epp2024vadis} vektorbasierte Struktur
