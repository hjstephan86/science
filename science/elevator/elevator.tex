...
\]
where $g = 9.81$ m/sÂ² is Earth's standard gravitational acceleration.
\end{definition}
...
\begin{itemize}
	...
	\item Corresponding number density: $n < 3 \times 10^{13}$ molecules/mÂ³
...
For the Einstein-Elevator ($V \approx 4$ mÂ³, $Q = 1000$ mÂ³/h):
\[
...
Substituting $t_1 = 0.5$ s, $t_2 = 3.8$ s, and $a_{\text{acc}} = 11.772$ m/sÂ²:
\begin{align}
s(0.5) &= 1.472 \text{ m} \\
