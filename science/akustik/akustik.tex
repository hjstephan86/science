...
\begin{satz}[Harmonische Konsonanz â€” Pythagoreisches Prinzip]
...
\begin{definition}[Reine Stimmung â€” Just Intonation]
...
\begin{definition}[Gleichstufige Stimmung â€” Equal Temperament]
...
\end{align*}
Nur die Septime (15:8) überschreitet knapp $G = 9$ â€” sie gilt traditionell als
...
Elemente $\{0,7,2,9,4,11,6,1,8,3,10,5\}$ â€” alle 12 Halbtöne werden durchlaufen.
...
der Durchführung fällt auf Takt 193 â€” Abweichung: $0{,}3\%$.
\end{beispiel}
...
\textbf{(ii)} Die C-Pentatonik $\{C,D,E,G,A\}$ enthält 5 der 7 diatonischen Töne â€”
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Raumakustik â€” Die Sabine-Formel}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
im Zeitbereich â€” die resultierende Wellenform zeigt die typische Sägezahnform
der idealen Saite.}
...
eine Transposition einer zyklischen Rotation im chromatischen Graphen â€” exakt das
...
Epp, S. (2026).
Der Subgraph Algorithmus â€” Lösung des Subgraph-Isomorphismus in $O(n^3)$. \url{https://github.com/hjstephan86/subgraph}

\bibitem{epp2026signal}
Epp, S. (2026).
Signaltheorie â€” Das Wunder der e-Funktion: Kontinuierliche und diskrete Signale. \url{https://github.com/hjstephan86/science/tree/main/science/signalth}

\bibitem{epp2026expl}
Epp, S. (2026).
Grenzen mathematischer Beschreibbarkeit â€” Taxonomie in 5 Klassen. \url{https://github.com/hjstephan86/science/tree/main/science/expl}
...
Epp, S. (2026).
Der Dirac-Impuls $\delta(t)$ â€” Formale Theorie im Rahmen der Distributionentheorie.
Google Drive (epp-group).
