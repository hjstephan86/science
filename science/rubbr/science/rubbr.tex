...
\end{equation}
Also ist $\Ltire$ maximal bei $p_i = \pref$. \qed
\end{proof}
...
Stabilitätsbedingung im Einheitskreis sichergestellt. \qed
\end{proof}
...
Variablen -- die Lösung existiert und ist eindeutig. \qed
\end{proof}
...
Trajektorie verschleißoptimal. \qed
\end{proof}
...
gleichmäßiger Verteilung maximal. \qed
\end{proof}
