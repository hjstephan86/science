...
% â”€â”€â”€ Pakete â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
% â”€â”€â”€ Theorem-Umgebungen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
% â”€â”€â”€ Hyperref-Konfiguration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\hypersetup{
  colorlinks=true,
  linkcolor=deepblue,
...
% â”€â”€â”€ AbkÃ¼rzungen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\newcommand{\MP}{Mikroplastik}
\newcommand{\NP}{Nanoplastik}
\newcommand{\eg}{z.\,B.\,}
\newcommand{\cf}{vgl.\,}

\title{Ã–kotoxikologische Wirkungen auf Korallenriffe, Kupfer-Dynamik unter Ozeanversauerung und erweiterte Reinigungsstrategien}
\author{Stephan Epp}
\date{20. April 2026}
...
\section{Ã–kotoxikologische Wirkungen auf Korallenriffe}
\label{sec:korallen_oekotox}
% â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

Die vorliegende Erweiterung integriert drei maÃŸgebliche Forschungsarbeiten des
...
Reinigungsanforderungen, ein erweitertes Schadensmodell fÃ¼r Korallen-Ã–kosysteme
und ein um SÃ¤ureeffekte korrigiertes Adsorptionsmodell abgeleitet.
Besonders kritisch: Unter intensiver Ozeanversauerung (pH\,$\approx 7{,}59$,
IPCC-SSP5-8.5-Szenario fÃ¼r 2100) verliert PET-Mikroplastik seine FÃ¤higkeit als
Kupfer-Vektor zu fungieren, was die BioverfÃ¼gbarkeit von toxischem Cu$^{2+}$
signifikant erhÃ¶ht.

\subsection{Einleitung und Forschungsstand}

Korallenriffe bedecken weniger als $0{,}1\,\%$ der Meeresbodenfl\"ache, beherbergen
jedoch schÃ¤tzungsweise $25\,\%$ aller marinen Spezies
\cite{plaisance2011diversity}. Sie sind unter den am stÃ¤rksten von \MP{}-Kontamination
bedrohten Ã–kosystemen der Erde -- eine Erkenntnis, die in den vergangenen drei
Jahren durch eine Vielzahl neuer Studien exponentiell untermauert wurde.

Isingoma et al.\ (2026) legen in ihrer Ãœbersichtsarbeit erstmals eine systematische
Analyse der physiologischen, zellulÃ¤ren und biochemischen Ebenen der
...
quantitativen Ableitungen verknÃ¼pft.
...
\begin{itemize}[noitemsep]
  ...
  \item Korallenriffe mit Plastikverschmutzung: Krankheitsrisiko $22\times$ hÃ¶her als
        stark ges\"utzte Riffe (Lamb et al.\ 2018)
  \item PET-Fasern (${>}500\,\mu$m) dominieren als Oberfl\"achen-AdhÃ¤sionsform;
  ...
  \item Mikroplastik-Abundanz in Korallensedimenten wird um Faktor $2\times$ 
        unterschÃ¤tzt, da Partikel in Biomineralien eingeschlossen sind
        (Chen et al.\ 2023)
\end{itemize}
\end{mdframed}
...
Die Ingestion von \MP{} durch Korallen induziert eine Ã¼bermÃ¤ÃŸige Produktion
...
Sei $[\text{MP}](t)$ die intrazell\"ulÃ¤re Mikroplastik-Konzentration zum Zeitpunkt $t$,
...
\begin{figure}[H]
  ...
  \caption{
    ...
    (Lanct\^{o}t et al.\ 2020). Alle Graphen basieren auf verÃ¶ffentlichten
...
Referenzwerte der Kontrolle bezeichnen. $H_I = 1$ bedeutet ungestÃ¶rte Symbiose;
...
$K$ die KapazitÃ¤tsgrenze, $\mu_{\text{MP}}$ der direkte MP-Verlustkoeffizient
und $\mu_{\text{ROS}}$ der ROS-vermittelte Verlustkoeffizient sind.
FÃ¼r \textit{S.~pistillata} bei $50\,\text{MP/mL}$ sch\"atzen wir
...
\begin{satz}[Kritische Plastisph\"aren-Dichte f\"ur PathogenÃ¼bertragung]
Sei $\rho_{\text{PS}}$ die Plastisph\"aren-Biofilm-Dichte auf \MP{}-OberflÃ¤chen
...
\end{equation}
wobei $A_{\text{MP}}$ die totale MP-OberflÃ¤che pro Liter Wasser,
...
\subsection{ReproduktionsbeeintrÃ¤chtigung und Larvalentwicklung}
\label{subsec:reproduktion}

Die Reproduktion ist ein energetisch hochintensiver Prozess in Korallenriffen.
\MP{}-Ingestion schafft eine \textit{falsche SÃ¤ttigungs-Signalgebung} (engl.\
...
chemoreceptive Phagostimulanzien in \MP{}-OberflÃ¤chen vermittelt wird
(Allen et al.\ 2017).
...
\begin{itemize}[noitemsep]
  \item HDPE-Leachat ($100$\,Partikel/L, $7\,\text{d}$): signifikante Reduktion
    des Ãœberlebens und der Besiedlung von \textit{Montipora~capitata}-Larven.
  ...
  \item Paradox: HDPE ($200$\,Partikel/L) f\"ordert Larvenbesiedlung durch
    attraktive chemische Leachat-Signale -- Risiko fÃ¼r Siedlung auf suboptimalem Substrat.
\end{itemize}

\begin{proposition}[ReproduktionseinbuÃŸe durch pseudo-SÃ¤ttigungseffekt]
Sei $E_{\text{repro}}$ die Energie, die fÃ¼r Reproduktion aufgewendet werden kann,
$E_{\text{total}}$ die Gesamtenergie und $f_{\text{PS}}$ der Anteil
nicht-nutritiver Ingestion (pseudo-SÃ¤ttigung):
\begin{equation}
...
FÃ¼r $c_1 = 1\,\text{MP/L}$ (Phytoplankton) ergibt sich bei
$\text{TMF} = 3{,}2$ und $f_{\text{assimilation}} = 0{,}85$:
$c_{\text{Koralle}} \approx 8{,}5$ (relativ), $c_{\text{Fisch}} \approx 42{,}3$,
was die in Abbildung~\ref{fig:trophisch} gezeigten Kurven begrÃ¼ndet.
...
\subsection{Problemstellung und Relevanz fÃ¼r Reinigungsstrategien}

Die Studie von Poersch et al.\ (2026) untersucht erstmals unter CO$_2$-getriebener
Ozeanversauerung (statt einfacher pH-Adjustierung mit SÃ¤ure/Base), wie sich die
BioverfÃ¼gbarkeit von Kupfer(II) in Gegenwart von photodegradiertem PET-Mikroplastik
ver\"andert \cite{poersch2026copper}. Dies ist unmittelbar relevant fÃ¼r
...
\begin{enumerate}[leftmargin=*]
  ...
  \item Reinigungstechnologien, die auf Adsorptionsprozessen basieren (z.\,B.\
    magnetische Nanopartikel, Aktivkohle-FilterbÃ¶jen), ebenfalls pH-abh\"angig
    sind und unter Versauerungsszenarien neu kalibriert werden mÃ¼ssen.
\end{enumerate}
...
moderaten zum intensiven Versauerungsszenario ist besonders bedeutsam fÃ¼r die
Cu-Speziation, da er die CO$_3^{2-}$-Konzentration um $33{,}9\,\mu$mol\,kg$^{-1}$
($-34\,\%$) reduziert -- und CO$_3^{2-}$ ist der prim\"are anorganische
Komplexierungsligand fÃ¼r Cu(II) in Meerwasser (Millero et al.\ 2009).
\end{bemerkung}

\subsection{Cu(II)-Speziation und BioverfÃ¼gbarkeit}
...
\subsection{Adsorptionsmodell fÃ¼r PET-Mikroplastik unter pH-Variation}
...
\begin{enumerate}[leftmargin=*]
  \item \textbf{Protonierungskonkurrenz:} Bei niedrigem pH konkurrieren H$^+$-Ionen
    mit Cu$^{2+}$ um Adsorptionspl\"atze auf der PET-OberflÃ¤che.
...
Die pH-abh\"angige Adsorptionskapazit\"at $q_{\max}(\text{pH})$ fÃ¼r Cu(II)
...
der Anteil der durch CO$_3^{2-}$-Konkurrenz blockierten PlÃ¤tze sind.
\end{definition}
...
\begin{korollar}[Grenzkonzentration fÃ¼r effektive Kupfer-Vektorfunktion]
...
\end{equation}
Unterhalb von pH~$7{,}75$ -- welches laut IPCC-SSP5-8.5 bis 2100 in groÃŸen
...
\begin{figure}[H]
  ...
  \caption{
    ...
    (Poersch et al.\ 2026).}
    Subplot~A: Gemessene initialie und finale Cu(II)-Konzentrationen fÃ¼r alle
    ...
    erh\"ohte Cu$^{2+}$-BioverfÃ¼gbarkeit.
  }
...
Die Kombination von Ozeanversauerung und erh\"ohter Cu$^{2+}$-BioverfÃ¼gbarkeit
...
\begin{itemize}[noitemsep]
  ...
  \item DNA-Sch\"aden, verminderte Larven\"uberlebensrate und Spermienmotilit\"at
    bei PolychÃ¤ten (Campbell et al.\ 2014)
  \item Reduziertes Wachstum, Histologische Sch\"aden bei KopffÃ¼\ss{}ern
    (Zheng et al.\ 2023)
\end{itemize}

In Verbindung mit den in Abschnitt~\ref{sec:korallen_oekotox} dargestellten
Korallen-Effekten ergibt sich ein Ã¶kologischer Schadensmultiplikator:
...
Cu-Toxizit\"ats-VerstÃ¤rker sind (gesch\"atzt aus Literaturdaten).
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{pH-kompensierter Cu-Vektorterm:} ReinigungsmaÃŸnahmen m\"ussen
...
da UVC-LED-Systeme in Schiffen und stationÃ¤ren Anlagen einsetzbar sind.
...
\begin{itemize}[noitemsep]
  ...
  \item UV-Absorbtion in tr\"ubem Tiefseewasser limitiert die Eindringtiefe auf
    $< 1$\,m (abhÃ¤ngig von der Partikelkonzentration).
\end{itemize}
...
\begin{figure}[H]
  ...
  \caption{
    \textbf{Erweiterte Reinigungsstrategien unter BerÃ¼cksichtigung neuer Forschungs\-
    ergebnisse.}
...
\subsection{Synthetische Bewertung der ForschungslÃ¼cken}
...
deckt sechs kritische ForschungslÃ¼cken auf, die bisher in der Planung
mariner Reinigungsstrategien unterbelichtet wurden:

\subsubsection{ForschungslÃ¼cke 1: Kombinierte Stressorwirkung auf Korallen}

Bisher wurden die Effekte von \MP{}, Ozeanversauerung und OzeanerwÃ¤rmung
Ã¼berwiegend in Isolation untersucht. Bove et al.\ (2023) zeigten als erste,
dass die stÃ¤rksten Immunantworten in \textit{Acropora cervicornis} erst
auftraten, wenn alle drei Stressoren gleichzeitig wirkten -- die
Genexpression der Immunantwort-Gene wurde dabei multiplikativ verstÃ¤rkt,
nicht additiv. Dies hat unmittelbare Implikationen fÃ¼r die RisikoabschÃ¤tzung:

\begin{satz}[Kombinierter Stressor-SuperlinearitÃ¤t]
Sei $D_i$ der Schaden durch Stressor $i \in \{\text{MP}, \text{pH}, T\}$ allein,
dann gilt fÃ¼r den kombinierten Schaden $D_{\text{kombi}}$ bei gleichzeitiger
Wirkung:
\begin{equation}
...
Tirpitz et al.\ 2025). FÃ¼r Reinigungsstrategien bedeutet dies: Das Ziel muss sein,
\textit{alle} Stressoren gleichzeitig zu mindern -- isolierte MaÃŸnahmen sind
ineffizienter als integrierte.
\end{satz}

Die konkreten Forschungsanforderungen sind:
\begin{itemize}[leftmargin=*, noitemsep]
  \item \textbf{Multistressor-Mesokosmen} (2026--2030): GroÃŸskalige (100--500\,L)
    Experimentalsysteme, die realistische Kombinationen aus MP-Konzentration,
    $p$CO$_2$, Temperatur und NÃ¤hrstoffbelastung simulieren.
  \item \textbf{Transkriptomische und proteomische Analysen} (2026--2032):
    ...
    FrÃ¼hwarnindikatoren fÃ¼r Ã¶kosystemische Kipppunkte.
  \item \textbf{Langzeit-Feldmonitoring} (ab 2027): Permanentes Monitoring-Netz
    ...
    Sensoren fÃ¼r MP, pH, Temperatur, Cu, Zooxanthellae-Dichte.
\end{itemize}

\subsubsection{ForschungslÃ¼cke 2: Tiefseekorallen und Kaltwasserkorallen}

Isingoma et al.\ (2026) betonen: Tiefseekorallen (Kaltwasserkorallen, z.\,B.\
\textit{Lophelia pertusa}) sind vollstÃ¤ndig heterotroph (kein Symbiodinium),
daher potentiell fÃ¼r alle post-Ingestion-Effekte anf\"alliger als ihre flacheren
Verwandten. Gleichzeitig sind sie durch die strukturelle KomplexitÃ¤t des Riffs
...
\textbf{Kritische ForschungsprioritÃ¤t:} Weltweit gibt es schÃ¤tzungsweise
...
Reinigungskonzepte fÃ¼r Tiefseekorallen erfordern vÃ¶llig andere Technologien
(Tauchroboter-Flotten, Sediment-Resuspension-Vermeidung) als Flachwassr-Systeme.
\end{mdframed}

\subsubsection{ForschungslÃ¼cke 3: Biologisch abbaubare Polymere in Korallenumgebungen}

Isingoma et al.\ (2026) verweisen auf die dringende Notwendigkeit, die
Ã¶kologische Sicherheit biologisch abbaubarer Alternativen (PHA, PLA, PHB,
StÃ¤rkepolymere) in Korallenriff-Ã–kosystemen zu evaluieren:
\begin{itemize}[noitemsep, leftmargin=*]
  \item Abbauprodukte (z.\,B.\ MilchsÃ¤ure aus PLA, HydroxybuttersÃ¤ure aus PHB)
    k\"onnen lokale pH-Senkungen verursachen und damit die Karbonat-Chemie
    unmittelbar neben Korallen beeinflussen.
  \item Biofilm-Bildung auf biopolymeren OberflÃ¤chen kann die
    PlastisphÃ¤ren-Effekte (Pathogenvektoren) reduzieren oder verstÃ¤rken --
    je nach Polymer und Temperatur.
  \item Lebenszyklusanalysen m\"ussen die vollstÃ¤ndige marine Degradationskette
    einschlieÃŸlich Zwischen- und Endprodukte abbilden.
\end{itemize}

\subsubsection{ForschungslÃ¼cke 4: Globales Plastics-Treaty und Korallen-Schutz}

Das Scheitern der INC-5.2-Plastiksvertragsverhandlungen in Genf (August 2025)
hinterlÃ¤sst eine entscheidende Governance-LÃ¼cke (Farrelly et al.\ 2025,
zitiert in Isingoma et al.\ 2026). Besonders problematisch:
\begin{itemize}[noitemsep, leftmargin=*]
  \item Produktionsobergrenzen fÃ¼r Petrochemikalien-exportierende Nationen
    wurden nicht vereinbart.
  \item Berichterstattungsmechanismen fÃ¼r nationale \MP{}-Emissionen fehlen.
  \item Spezifische SchutzmaÃŸnahmen fÃ¼r korallenreiche EEZs (z.\,B.\
...
\begin{enumerate}[noitemsep, leftmargin=*]
  \item Stufenweise verbindliche Produktionsreduktionen mit klaren ZeitplÃ¤nen.
  \item Technologietransfer-Fonds fÃ¼r EntwicklungslÃ¤nder zur Etablierung
    alternativer Polymerherstellung.
  \item UnabhÃ¤ngige Monitoring- und Verifikationsmechanismen.
  \item Sanktionsmechanismen bei Nichteinhaltung.
\end{enumerate}

\subsubsection{ForschungslÃ¼cke 5: Mikroplastik als Kupfervektor und Fischereisicherheit}

Die Erkenntnisse von Poersch et al.\ (2026) Ã¼ber die pH-abhÃ¤ngige
Kupfer-Vektor-Funktion von PET-Mikroplastik erÃ¶ffnen eine bislang kaum
...
akkumulieren, und wenn diese AdsorptionsfÃ¤higkeit unter Ozeanversauerung nachlÃ¤sst,
dann steigt die direkte Cu$^{2+}$-Exposition der Organismen -- mit potentiell
steigenden Cu-Gehalten in Korallenriff-Fischen, die fÃ¼r den menschlichen
...
Eine systematische RisikoabschÃ¤tzung fÃ¼r die Lebensmittelsicherheit unter
IPCC-Versau\-erungsszenarien fehlt bisher vollstÃ¤ndig.

\subsubsection{ForschungslÃ¼cke 6: Nanoplastik in Korallenriff-Ã–kosystemen}
...
exponentiell zu -- NP kann in Mitochondrien eindringen, die EnergiehomÃ¶ostase
direkt beeinflussen und EpigenomverÃ¤nderungen auslÃ¶sen.
...
fÃ¼r alle Reinigungseffizienz-Bewertungen.

\subsection{VisionÃ¤re Langzeit-Forschungsagenda 2026--2100}
...
\begin{enumerate}[noitemsep, leftmargin=*, label=\textbf{F\arabic*.}]
  ...
  \item \textbf{F2 (2026--2032):} Multistressor-Mesokosmen-Experimente
    ...
    fÃ¼r Gleichung~\eqref{eq:superlinear_damage}.
  ...
  \item \textbf{F4 (2028--2038):} Biologische BekÃ¤mpfung mariner MP durch
    marine Plastik-abbauende Konsortien (\textit{Ideonella~sakaiensis}-Analoga);
    Evolution gezielter Enzym-Cocktails fÃ¼r PE, PP, PVC.
  \item \textbf{F5 (2029--2040):} Tiefseereinigungs-Robotik: autonome AUV-Flotten
    mit MP-Detektions- und Sammelmodulen fÃ¼r Korallensediment-Sanierung.
  \item \textbf{F6 (2030--2045):} VollstÃ¤ndige Lebenszyklus- und Ã–kotoxiko\-
  ...
  \item \textbf{F7 (2032--2050):} Satelliten-basiertes Ocean-\MP{}-Monitoring
    (Hyper\-spektral-Fernerkundung) mit KI-gestÃ¼tzter Echtzeit-Risikokartiering.
  \item \textbf{F8 (2035--2060):} Globales allgemeines Gleichgewichtsmodell (CGE)
    zur makroÃ¶konomischen Bewertung der Plastiksubstitution unter Einbeziehung
    der Korallen-Ã–kosystemleistungen (KÃ¼stenschutz, Fischerei, Tourismus).
  \item \textbf{F9 (2040--2070):} Genetische Adaptation von Korallen an erhÃ¶hte
    MP-Konzen\-tration: Zucht stress-toleranterer Genotypen fÃ¼r Korallen-Restauration.
  \item \textbf{F10 (2050--2100):} Integration globaler ReinigungsmaÃŸnahmen mit
    CO$_2$-Ent\-nahme-Technologien (CDR): Synergieeffekte zwischen Plastikentfernung
    und pH-Stabilisierung fÃ¼r Korallenriff-Ã–kosysteme.
\end{enumerate}
\end{mdframed}

\subsection{Quantitative Prognose: Korallen-Ã–kosystem unter Szenarien 2025--2100}
\label{subsec:korallen_prognose}

Auf Basis der in Abschnitt~\ref{sec:korallen_oekotox} hergeleiteten Modelle und der
Daten aus den drei SchlÃ¼sselstudien leiten wir eine quantitative Prognose des
...
\begin{table}[H]
  ...
  \caption{Quantitative Prognose des Global Coral Health Index (GCHI) unter
           ...
           MaÃŸnahmen (Dreiphasen-Konzept + neue Forschungserkenntnisse);
           OPT = Optimistisches Szenario (sofortige globale MaÃŸnahmen).
...
\begin{bemerkung}
Das BAU-Szenario projiziert ein nahezuvollstÃ¤ndiges Versagen der globalen
Korallenriff-Ã–kosysteme bis 2100 (GCHI $= 0{,}04$), ein Ergebnis konsistent mit
IPCC-Projektionen und den Modellen von Isingoma et al.\ (2026). Das Integrierte
MaÃŸnahmen-Szenario stabilisiert den GCHI bei ${\approx}0{,}28$ -- eine massive
...
Die Analyse der drei integrierten Forschungswerke fÃ¼hrt zu einer fundamentalen
Neukonzeptionierung der Bedrohungslage fÃ¼r marine Ã–kosysteme:
...
Stressor verstÃ¤rkt die Wirkung der anderen.
...
\begin{enumerate}[leftmargin=*, label=\textbf{K\arabic*.}]
  \item PET-Mikroplastik verliert seine Cu-Vektor-Adsorptionsfunktion bei
    ...
    IPCC-SSP5-8.5 groÃŸfl\"achig bis 2100 eintreten wird.
  \item Korallen-SchÃ¤den durch \MP{} sind superlinear: Der kombinierte
    Schadensterm aus Gleichung~\eqref{eq:damage_multiplier} Ã¼bersteigt die
  ...
  \item Der Global Coral Health Index wird ohne integrierte MaÃŸnahmen
    bis 2100 auf $0{,}04$ absinken -- ein faktischer Ã¶kologischer Kollaps
    fÃ¼r $25\,\%$ aller marinen Spezies.
  \item Das Scheitern globaler Plastik-Vertragsverhandlungen (INC-5.2, August 2025)
    ...
    um $\approx 0{,}10$--$0{,}15$ Einheiten nach unten drÃ¼ckt im Vergleich
    zu einem erfolgreichen Vertragsschluss.
\end{enumerate}

Die Weltmeere k\"onnen geheilt werden -- aber nur, wenn die VerschrÃ¤nkung der
