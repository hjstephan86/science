...
\begin{enumerate}[label=(\alph*)]
  ...
  \item \textbf{Subgraph-basierte Regelungsgraphen:} Der Subgraph Algorithmus
        \cite{epp2024subgraph} kann eingesetzt werden, um Regelungstopologien
...
S.~Epp, Der Subgraph Algorithmus, 2026, Verfügbar auf \url{https://gitlab.com/epp-group/subgraph}.
