...
\subsection{Säure-Base-Paare nach BrÃ¸nsted-Lowry}

Nach der BrÃ¸nsted-Lowry-Definition~\cite{bronsted1923} bilden Säure und Base
ein komplementäres Paar durch Protonenübertragung:

\begin{definition}[BrÃ¸nsted-Lowry-Komplementärpaar]
	Eine Säure $\mathrm{HA}$ und eine Base $\mathrm{B}$ bilden ein
	\emph{BrÃ¸nsted-Lowry-Komplementärpaar}, wenn die Protonenübertragungsreaktion
	\[
...
Unveröffentlichtes Manuskript, Januar 2026.
