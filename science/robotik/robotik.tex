...
\begin{lemma}[$\varphi$-Fibonacci-PfadlÃ¤ngen]
\label{lem:fib_path}
...
F\"ur gro{\ss}e RoboterschwÃ¤rme ($m > 100$) ist Zentralisierung nicht
praktikabel.
...
\subsection{Verbindung zur atmosphÃ¤rischen Systemtheorie}
...
Gro{\ss}e RoboterschwÃ¤rme zeigen emergente kollektive Intelligenz
...
\subsection{Phi-optimale ExtremitÃ¤t-Koordination in der Biomechanik}

Die $\varphi$-Fibonacci-Winkelverteilung (Lemma~\ref{lem:fib_path})
tritt biologisch auf: Bl\"atter an Pflanzenstielen folgen dem
Fibonacci-Winkel $\theta = 2\pi/\varphi^2 \approx 137{,}5Â°$ (Phyllotaxis~\cite{epp2026expl}).
...
Aufeinander folgende Drehungen um $2\pi/\varphi^2 \approx 137{,}5Â°$
...
In der Praxis sind Roboter-KonfigurationsrÃ¤ume unsicher:
