...
% ============================================================
	...
	\begin{figure}[h]
		...
		\caption{Experiment~01: \textbf{Links} â€“ Arrhenius-Ratenverhältnis $k(T)/k(T_0)$ für vier
			...
			\textbf{Rechts} â€“ SEI-Schichtdickenwachstum $\delta(t)$ in Nanometer über ein Jahr
	...
	\begin{figure}[h]
		...
		\caption{Experiment~02: Spannungsbedingte Degradationsraten. \textbf{Links} â€“
			...
			\textbf{Rechts} â€“ Unterspannungs-Degradationsrate $r_\mathrm{under}(\eta)$:
	...
	\begin{figure}[h]
		...
		\caption{Experiment~03: Thermisches Zellmodell. \textbf{Links} â€“ Temperaturverlauf
			$T(t)$ bei Schnellladevorgängen mit verschiedenen Stromraten ($1\,C$ bis $4\,C$).
			\textbf{Rechts} â€“ Wärmegenerationsrate $\dot{Q}(I)$ als Funktion der Stromstärke
	...
	\begin{figure}[h]
		...
		\caption{Experiment~04: Thermischer Verbesserungsfaktor $\Phi_T$. \textbf{Links} â€“
			...
			\textbf{Rechts} â€“ $\Phi_T$ als Funktion der AI-PMM-Betriebstemperatur
	...
	\begin{figure}[h]
		...
		\caption{Experiment~05: Kombinierter Verbesserungsfaktor. \textbf{Links} â€“
			...
			$\gamma_V^*$. \textbf{Rechts} â€“ Gesamtfaktor $\Phi$ in Abhängigkeit des
	...
	\begin{figure}[h]
		...
		\caption{Experiment~06: Reichweite und Kälteverhalten. \textbf{Links} â€“
			Normierter Reichweiteverlauf $R(n)/R_0$ als Funktion der Zyklenanzahl für
			AI-PMM und statisches PMS (EV-B). \textbf{Rechts} â€“ Kältebedingte Kapazitätsreduktion
	...
	\begin{figure}[h]
		...
		\caption{Experiment~07: Mechanische Modelle. \textbf{Links} â€“ Volumetrische Quellung
			der Graphitanode $\varepsilon_\mathrm{vol}(\mathrm{SoC})$ und Tortuosität
			$\tau(d_\mathrm{sep})$ als Funktion des Plattenabstands.
			\textbf{Rechts} â€“ Mechanische Degradationsrate $r_\mathrm{mech}(\sigma)$ als Funktion
	...
	\begin{figure}[h]
		...
		\caption{Experiment~08: Erweiterter Gesamtverbesserungsfaktor $\Phi_\mathrm{ges}$.
			\textbf{Links} â€“ $\Phi_\mathrm{ges}$ als Funktion des relativen mechanischen
			Degradationsanteils $\rho_M$ für drei Werte von $\eta_M$.
			\textbf{Rechts} â€“ $\Phi_\mathrm{ges}$ als Funktion des Basisverbesserungsfaktors
	...
	\begin{figure}[h]
		...
		\caption{Experiment~09: Simulation LP1 (Smartphone-Nutzungsprofil). \textbf{Links} â€“
			Zelltemperatur $T(t)$ über 24 Stunden für AI-PMM und statisches PMS.
			\textbf{Rechts} â€“ Kumulierte Degradation $\mathcal{D}(t)$ für beide Systeme
	...
	\begin{figure}[h]
		...
		\caption{Experiment~10: Simulation LP2 (E-Bike-Nutzungsprofil). \textbf{Links} â€“
			Verlauf des Ladezustands $\mathrm{SoC}(t)$ über eine typische Fahrtage für AI-PMM
			und statisches PMS. \textbf{Rechts} â€“ Instantane Degradationsrate $\dot{\mathcal{D}}(t)$
			für beide Systeme.}
		\label{fig:exp10}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\caption{Experiment~11: Simulation LP3 (Stationärer Speicher). \textbf{Links} â€“
			Zellspannung $V(t)$ über 24 Stunden für AI-PMM und statisches PMS bei Netzein-
			speisung und -bezug. \textbf{Rechts} â€“ Zelltemperatur $T(t)$ über denselben Zeitraum.}
		\label{fig:exp11}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\caption{Experiment~12: Systemvergleich über alle drei Lastprofile. \textbf{Links} â€“
			...
			\textbf{Rechts} â€“ Simulierter Verbesserungsfaktor $\Phi_\mathrm{sim}$ pro Lastprofil
	...
	\begin{figure}[h]
		...
		\caption{Experiment~13: Langzeitdegradation durch SEI-Wachstum. \textbf{Links} â€“
			SEI-bedingter kumulierter Kapazitätsverlust $\Delta Q_\mathrm{SEI}(t)$ über
			fünf Jahre bei drei Betriebstemperaturen. \textbf{Rechts} â€“ Kapazitätsdrift
	...
	\begin{figure}[h]
		...
		\caption{Experiment~14: Parametersensitivität und Vorheizmanagement. \textbf{Links} â€“
			...
			\textbf{Rechts} â€“ Vorheizeffizienz $\eta_\mathrm{heat}$ (km\,kWh$^{-1}$) als
	...
	\begin{figure}[h]
		...
		\caption{Experiment~15: EV-Gesamtbeweis und MPC-Referenz. \textbf{Links} â€“
			...
			Mehrkilometer-Gewinn. \textbf{Rechts} â€“ MPC-Referenztrajektorie $d_\mathrm{ref}(\mathrm{SoC})$
	...
	\begin{table}[H]
		...
		\begin{tabular}{lccccc}
			...
			$N_{\mathrm{Zyklen}}$ & Kosten [â‚¬/kWh] & TRL \\
			\midrule
	...
	\begin{figure}[H]
		...
		\caption{Kosten-Nutzen-Analyse: Reichweite vs.\ Batteriekosten
		         [â‚¬/kWh]. Fehlerbalken: $\pm 1\sigma$. Die günstigsten
	...
	$85\,\text{â‚¬/kWh}$ die kostengünstigste Technologie ist, gefolgt
	von LFP ($90\,\text{â‚¬/kWh}$). Solid-State weist mit
	$350\,\text{â‚¬/kWh}$ die höchsten Kosten auf, was zum aktuellen
	Entwicklungsstand auf Fertigungsaufwand und geringe Stückzahlen
	zurückzuführen ist. Bei Massenproduktion werden Kosten von
	$120$--$150\,\text{â‚¬/kWh}$ erwartet \cite{Winter2018}, was Solid-State
	...
	\begin{proposition}[Kosten-Nutzen-Dominanz für heutige Serienanwendungen]
		...
		$K \leq 100\,\text{â‚¬/kWh}$ ist LFP die optimale Wahl:
		\begin{equation}
