...
Dieses Konzept â€“ und seine weitreichenden Konsequenzen für OTA-Update-Systeme
â€“ stehen im Mittelpunkt der vorliegenden Arbeit.
...
Fahrzeugfunktion â€“ Motorsteuerung, Bremsenregelung, Klimaautomatik,
Infotainment â€“ in einem dedizierten Steuergerät (\gls{ecu}) verankert.
...
üblichen ECU-Anzahl aus â€“ bei gleichzeitig erheblich größerem
...
\textbf{100 Millionen Zeilen Quellcode} â€“ mehr als ein modernes
...
Die rechenintensiven Aufgaben â€“ Sensorfusion, Fahrfunktionsberechnungen,
Update-Koordination â€“ werden auf zentrale \glspl{hpc} verlagert, die
...
AUTOSAR â€“ als der dominierende Softwarestandard der Fahrzeugelektronik â€“
...
im Einsatz â€“ ein Fahrzeug enthält heute typischerweise \emph{beide}
...
zeitgestaffelt und zustandsabhängig an \emph{Peripheriesteuergeräte (PSG)} â€“
...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Unzureichende Rollback-Mechanismen}:
    Im \gls{sdv} mit heterogener Plattform â€“ mehrere klassische
    Mikrocontroller-SGs neben leistungsstarken Adaptive-Plattform-Knoten â€“
  ...
  \item \textbf{Sicherheitsanforderungen im \gls{sdv}-Kontext}:
    Der erweiterte Connectivity-Footprint des \gls{sdv} â€“ permanente
    Backend-Verbindung, V2X-Kommunikation, Ladeleitungskommunikation â€“ macht
...
eingespielt werden. Ein partiell eingespieltes Update â€“ bei dem beispielsweise
der Algorithmus für eine ADAS-Funktion auf dem HPC aktualisiert ist, der
zugehörige Sensor-Treiber auf dem Zonensteuergerät jedoch nicht â€“ kann zu
...
\begin{description}
  ...
  \item[Continuous Deployment (CD) im Fahrzeug:] In Entwicklungsfahrzeugen und
    ...
    getestet und eingespielt werden â€“ analog zu modernen Cloud-Deployments.
\end{description}
...
\textbf{Zentralsteuergeräts (ZSG)} â€“ im Englischen \textit{Central Update
Gateway ECU (CUGE)} â€“ das als einziger Kommunikationspartner des
...
sequenziell oder â€“ sofern voneinander unabhängig â€“ parallelisiert über
...
\paragraph{Phase 1 â€“ Benachrichtigung und Download (t = 0â€“15 min)}
...
\paragraph{Phase 2 â€“ Update des Türsteuerungs-SGs (t = 15â€“18 min)}
...
\paragraph{Phase 3 â€“ Update des Radar-SGs (t = 18â€“35 min)}
...
\paragraph{Phase 4 â€“ Update des Bremsen-SGs (t = 35â€“42 min)}
...
\paragraph{Phase 5 â€“ Finalisierung (t = 42â€“45 min)}
...
\begin{itemize}
  ...
  \item \textbf{Transaktionales Update}: Alle Update-Schritte sind
    transaktional â€“ bei Abbruch wird automatisch rollback ausgeführt.
\end{itemize}
...
Aufgaben â€“ Download, Staging, Verteilung und Koordination â€“ und entlastet
...
Multi-SG-Update in unter 45 Minuten â€“ einschließlich Rollback-Fähigkeit â€“
...
Konzepte â€“ das Zentralsteuergerät als Update-Gateway, das zeitgestaffelte
Verteilungsprotokoll sowie der hierarchische Zustandsautomat â€“ bilden
...
\textbf{formalen Spezifikationssprache} â€“ etwa in \textit{UPPAAL}
(Timed Automata), \textit{SPIN}/Promela oder \textit{TLA+} â€“
...
Fehleranstieg den Rollout auf die Gesamtflotte ausweiten â€“ ein
...
Kritikalität â€“ insbesondere für zukünftige vollautonome Fahrzeuge
(SAE Level\,4/5) â€“ ist eine redundante ZSG-Architektur unumgänglich.
...
Die in dieser Arbeit eingesetzten kryptographischen Verfahren â€“
ECDSA mit P-256 für Signaturen, AES-GCM für die symmetrische
Verschlüsselung und TLS\,1.3 für den Backend-Kanal â€“ entsprechen dem
...
für die sichere \textbf{In-Field-Zertifikatsrotation} â€“
analog zum ACME-Protokoll in der Webinfrastruktur â€“ ist für
...
Freischalten von Fahrzeugfunktionen gegen Entgelt â€“ etwa Sitzheizung,
...
werden kann. Die technische Dokumentation des Update-Prozesses â€“
insbesondere der lückenlose Nachweis von kryptographischer Integrität,
Rollback-Kompletheit und Nutzereinwilligung â€“ gewinnt damit auch
...
und Auditierbarkeit bietet â€“ und damit eine
...
M.~Broy, â€žChallenges in Automotive Software Engineering," in
...
D.~K.~Nilsson und U.~E.~Larson, â€žSecure Firmware Updates over the Air in
...
S.~Halder, A.~Ghosal und M.~Conti, â€žSecure OTA Software Updates in
...
D.~Zelle, T.~Lauser und C.~Krau{\ss}, â€žAnalyzing and Securing SOME/IP
...
P.~Mundhenk et al., â€žSecurity in Automotive Networks: Lightweight
...
\bibitem{jo2021ovota}
S.~Jo, J.~Park, Y.~Shin und Y.~Kwon, â€žOVOTA: Toward Secure OTA Update
...
S.~Kugele, D.~Hettler und J.~Peter, â€žData-Centric Communication and
...
T.~Schneider und M.~Vick, â€žLadekommunikation meets SDV -- Ladecontroller in
