%% fig_timeline.tex
%% Zeitlicher Ablauf des gestaffelten Update-Szenarios (Gantt-Ã¤hnlich)
\begin{tikzpicture}[
  x=0.22cm, y=1.0cm,
...
\node[font=\small\bfseries] at (-6, -2)  {\textcolor{autosarorange}{TÃ¼r-SG}};
...
%% TÃ¼r-SG Update: Transfer 15-16 min, Installation 16-18 min
...
\fill[barZSG, fill opacity=0.7] (42, -1.35) rectangle (45, -0.65)
  node[midway, font=\tiny] {Backend-BestÃ¤tigung};
