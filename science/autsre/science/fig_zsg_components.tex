...
\node[existbox] (csm)    at (5.5, 1.6)
  {Crypto Service Manager\\{\tiny(CSM â€“ AUTOSAR)}};
\node[existbox] (nm)     at (5.5, 5.2)
  {Network Management\\{\tiny(NM â€“ AUTOSAR)}};
\node[existbox] (dcm)    at (5.5, 7.0)
  {Diagnostic Manager\\{\tiny(DCM/DEM â€“ AUTOSAR)}};
\node[existbox] (nvm)    at (-5.5, 5.2)
  {NV Memory Manager\\{\tiny(NvM â€“ AUTOSAR)}};
\node[existbox] (wdg)    at (-5.5, 1.6)
  {Watchdog Manager\\{\tiny(WdgM â€“ AUTOSAR)}};
