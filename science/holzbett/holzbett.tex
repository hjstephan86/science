...
\title{
  ...
  {\normalsize Mittelträger ohne Bodenstütze â€“ Zwei nebeneinander liegende Lattenroste}
}
...
\subsection{Seitenansicht â€“ Querschnitt durch den Zentralträger}
...
\end{tikzpicture}
\caption{Detail A: Zapfenlager â€“ Draufsicht auf Kopf-/Fußholm. Der Zentralträger sitzt $30\,\text{mm}$ tief in der Aussparung und wird von unten verschraubt.}
\end{figure}
...
Für zwei Personen Ã  $100\,\text{kg}$ auf $2\,\text{m}^2$ ergibt sich $q = 0{,}98\,\text{kN/m}^2$;
...
\subsubsection*{Schritt 2 â€“ Zapfenlager im Kopf- und Fußholm fräsen}
...
\subsubsection*{Schritt 5 â€“ Zentralträger einsetzen}
...
\subsubsection*{Schritt 7 â€“ Lattenroste einlegen und abschließende Prüfung}
