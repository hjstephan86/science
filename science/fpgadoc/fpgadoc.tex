...
Die Unterscheidung zwischen diesen beiden Deployment-Pfaden â€” dem
\texttt{.bit}-Format für SRAM und dem \texttt{.bin}-Format für Flash â€”
...
konfiguriert sich beim Einschalten vollautomatisch aus dem Flash â€” ohne
...
und wartbar} sein â€” auch Jahre nach seiner Erstellung, auch ohne den
...
\begin{figure}[htbp]
    ...
    Rechts: Boot-Sequenz beider Pfade im Zeitstrahl â€” Flash konfiguriert den
...
\begin{lemma}[Zeitpunkt der Dokumentationspflicht]
    ...
    den Bitstrom in den SPI-Flash zu schreiben â€” nicht erst danach.
\end{lemma}
...
\begin{satz}[Dokumentation als Workflowbestandteil]
    ...
    Bestandteil des Entwurfsworkflows sein â€” nicht ein optionaler
...
\begin{proof}
    ...
    Syntheseablauf zu wiederholen â€” was dem Workflow widerspricht.
...
\begin{figure}[htbp]
    ...
    zur technischen Implementierung â€” nicht sequenziell danach.}
    \label{fig:gantt}
\end{figure}
...
\begin{figure}[htbp]
    ...
    Zuverlässigkeit belegen. Rechts: Zeitanteile im Entwurfsworkflow â€”
...
\begin{enumerate}
    ...
    \item \textbf{Hardware Manager öffnen:} \texttt{Open Hardware Manager
          â†’ Open Target â†’ Auto Connect}.
    \item \textbf{Flash programmieren:} Rechtsklick auf den FPGA
          \texttt{â†’ Add Configuration Memory Device â†’ Winbond W25Q128}
          \texttt{â†’ Program Configuration Memory Device â†’ .bin auswählen}.
    \item \textbf{Jumper setzen:} JP1 auf \texttt{SPI} (nicht JTAG).
    \item \textbf{Neustart:} Stromversorgung trennen und wieder anlegen â€”
...
integriert werden: \texttt{Tools â†’ Settings â†’ Implementation â†’ Tcl Scripts
â†’ tcl.post}. Damit ist sichergestellt, dass kein Bitstrom ohne vollständige
Dokumentation erzeugt werden kann â€” die Pflicht wird technisch durchgesetzt.
...
\begin{itemize}
    ...
    \item Den SHA-256-Hash des Bitstroms (nicht den Bitstrom selbst â€”
...
liefern maschinengeprüfte Korrektheitsnachweise â€” stärker als
...
Für sicherheitskritische Anwendungen von FPGA-Designs â€” Automotive, Medizintechnik,
Industrieautomation â€” schreiben Normen die Dokumentation zwingend vor.
...
Das Konzept des \emph{Digitalen Zwillings} â€” ein virtuelles Modell eines
physikalischen Geräts, das synchron mit dem realen Gerät gehalten wird â€”
...
in Software zu simulieren â€” für Regressionstests, Fehleranalyse und
Weiterentwicklung ohne das physikalische Board.

\subsection{Blockchain-basierte Dokumentationsintegrität}

Für höchste Anforderungen an die Unveränderlichkeit der Dokumentation â€”
etwa in der Medizintechnik oder Luft- und Raumfahrt â€” bietet sich die
...
Grundsatz â€” Dokumentation als integraler Workflowbestandteil â€” technisch
erzwingen.
...
\begin{itemize}
    \item Neue Kanten im Designgraph â†’ neue Verbindungen â†’ XDC muss
          aktualisiert sein.
    \item Neue Knoten â†’ neue Logikblöcke â†’ Utilization-Report muss
          sich geändert haben.
    \item Identische Graphen bei verschiedenen Versionsnummern â†’ Warnung:
...
\emph{ISO~26262: Road Vehicles â€” Functional Safety},
2nd Edition, ISO, 2018.

\bibitem{iec62304}
International Electrotechnical Commission,
\emph{IEC~62304: Medical Device Software â€” Software Life Cycle Processes},
Edition 1.1, IEC, 2015.

\bibitem{quadrant2020}
C. Wolf,
\emph{Yosys Open SYnthesis Suite â€” Internals and Applications},
