...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{\textit{Links:} Nichtlineare Regression mit 95\%-Konfidenzintervall.
			\textit{Rechts:} Residualanalyse â€“ die Residuen sind zufällig verteilt,
	...
	\emph{einzig mögliche} funktionelle Form ist (Theorem~3.1â€“3.3).
	...
	synaptischen Rauschquellen beschreibt. Das ItÃ´-Lemma liefert die
	...
	Tatsächlich gibt es Hinweise auf Polyaden â€“ höhere synaptische Strukturen,
	...
	\]
	Der zweite Term beschreibt irreversible Dekohärenz â€“ den Quantenanalogon
	...
	Dies eröffnet die Frage, ob Gedächtnissuperpositionen â€“ gleichzeitige
	Aktivierung mehrerer Erinnerungszustände â€“ quantenmechanisch modelliert
	werden können.
	...
	vorhersagt â€“ Diversität stabilisiert kollektives Gedächtnis.
	...
	\begin{thebibliography}{99}
		...
		\bibitem[Bliss und LÃ¸mo(1973)]{bliss1973lasting}
		Bliss, T.\,V.\,P. und LÃ¸mo, T. (1973).
