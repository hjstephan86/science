...
\section{Ãœbersetzungsregeln und Operatoren}
\label{sec:operatoren}
% â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

Dieses Kapitel definiert die vollstÃ¤ndigen Ãœbersetzungsregeln von den
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Filteroperatoren}
\label{tab:filter_ops}
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{lXXX}
\toprule
\textbf{IQT-PrÃ¤dikat} & \textbf{Python} & \textbf{Java} & \textbf{C\#} \\
\midrule
$\mathtt{EQ}(a, v)$
  & \texttt{Model.col == v}
...
\textbf{SQL-Generierungsregel fÃ¼r FILTER:}
\begin{align*}
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Projektionsoperatoren}
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Sortieroperatoren}
\label{tab:sort_ops}
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{lXXX}
\toprule
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: LIMIT / OFFSET je Datenbankdialekt}
\label{tab:limit_ops}
\renewcommand{\arraystretch}{1.4}
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Aggregationsfunktionen}
\label{tab:agg_ops}
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{lXXX}
\toprule
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Join-Typen}
\label{tab:join_ops}
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{lXXX}
\toprule
...
\begin{regel}[JOIN-Ãœbersetzung]
\label{regel:join}
FÃ¼r einen \texttt{INNER JOIN} zwischen Relation $L$ (Alias $t_1$) und $R$ (Alias $t_2$)
mit PrÃ¤dikat $p$ ergibt sich:
\[
...
KonformitÃ¤tsstufe CL-3 unterstÃ¼tzt.

\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Fensterfunktionen}
...
\begin{sidewaystable}
\centering
\caption{Ãœbersetzungstabelle: Unterabfragen}
...
\begin{table}[H]
\centering
\caption{Ãœbersetzungstabelle: Mengenoperationen}
\label{tab:set_ops}
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{lXXX}
\toprule
