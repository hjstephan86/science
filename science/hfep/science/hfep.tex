...
% â”€â”€ Theorem-Umgebungen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
\theoremstyle{plain}
...
% â”€â”€ Cleveref: deutsche Bezeichner fÃ¼r eigene Theorem-Umgebungen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
% â”€â”€ Farben â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
% â”€â”€ Makros â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
\begin{document}
	...
	moderner FlÃ¼ssigkeitsraketen.
	
	Ausgehend von der Tsiolkovsky-Gleichung werden vollstÃ¤ndige analytische und numerische
	Beweise erbracht, dass ein \HFEP-System bei gleichem Startgewicht einen
	Geschwindigkeitszuwachs $\Dv > \SI{120}{km/s}$ akkumulieren kann, wÃ¤hrend chemische
	Systeme auf $\Dv \lesssim \SI{9}{km/s}$ beschrÃ¤nkt bleiben.
	Kernresultate sind:
	...
	\begin{enumerate}
		...
		Treibstoffmasse wÃ¤chst um den Faktor $\sim 27$.
		\item \textbf{Langlebigkeitstheorem}: Die Kapsel ist durch Reaktorenergie
		fÃ¼r $\geq \SI{20}{Jahre}$ unabhÃ¤ngig von Sonnenlicht betreibbar.
		\item \textbf{RÃ¼ckkehrsicherheitstheorem}: Ein vierstufiges
		Bremsprogramm garantiert einen sicheren Wiedereintritt mit
		$v_{\mathrm{entry}} \leq \SI{11.5}{km/s}$.
	\end{enumerate}
	
	\noindent\textbf{SchlÃ¼sselwÃ¶rter:}
	...
	MassenverhÃ¤ltnis $\mzero/\mf$ \cite{tsiolkovsky1903, sutton2010}. FÃ¼r eine Flucht aus dem Sonnensystem
	($\Dv \approx \SI{42}{km/s}$) benÃ¶tigt ein chemisches System mit
	$\Isp = \SI{450}{s}$ ein MassenverhÃ¤ltnis von
	\begin{equation}
	...
	eine physikalische AbsurditÃ¤t, die durch kein chemisches Treibstoffpaar Ã¼berwunden
	werden kann, da die spezifischen Impulse durch die Bindungsenergien der MolekÃ¼le
	fundamental begrenzt sind.
	
	\subsection{Visi: Das HFEP-Konzept}
	
	Das \textbf{Hybride Feldeffekt-Antriebssystem} (\HFEP) Ã¼berwindet diese Schranke
	...
	\begin{enumerate}
		...
		mit einem neuartigen toroidal-poloidalen FeldkÃ¤fig auf
		AusstrÃ¶mgeschwindigkeiten $\ve > \SI{120}{km/s}$ beschleunigt.
		
		\item \textbf{Kompakter Kernspaltungsreaktor (KSR-2):}
		Ein miniaturisierter Festkernreaktor ($m_R \approx \SI{800}{kg}$,
		$P \approx \SI{2}{MW}$) liefert kontinuierlich Strom fÃ¼r MESI ---
		unabhÃ¤ngig von Sonnenlicht und Batterielebensdauer.
		...
		ausreichend Treibstoff fÃ¼r den RÃ¼ckweg zu reservieren.
	\end{enumerate}
	
	% â”€â”€ TikZ: HFEP Systemarchitektur â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
	...
	\begin{definition}[Spezifischer Impuls]
		Der \emph{spezifische Impuls} $\Isp$ eines Triebwerks ist definiert als das VerhÃ¤ltnis
	...
	\begin{theorem}[Tsiolkovsky-Gleichung, erweitert]
		FÃ¼r eine Rakete mit zeitlich variablem Massenfluss $\mdot(t) \geq 0$, konstanter
		AusstrÃ¶mgeschwindigkeit $\ve$ und ohne Ã¤uÃŸere KrÃ¤fte gilt:
		\begin{equation}
		...
		\end{equation}
		\begin{proof}
			Newtonsches Grundgesetz fÃ¼r das System Rakete + Treibstoffstrahlmasselement:
	...
	\begin{theorem}[Thermodynamische Schranke fÃ¼r $\Isp$]
		\label{thm:isp_limit}
		FÃ¼r exotherme chemische Reaktionen mit Reaktionsenthalpie $\Delta H_R$ und
		...
		\begin{proof}
			Die ideale isentrope DÃ¼senstrÃ¶mung liefert
			$\ve = \sqrt{2c_p T_0(1-(p_e/p_0)^{(\gamma-1)/\gamma})}$.
			Der maximale Betrag ist durch die Reaktionstemperatur $T_0$ beschrÃ¤nkt, welche
			ihrerseits durch $\Delta H_R = \int_0^{T_0}\!c_p\,dT$ bestimmt wird. Der beste
			verfÃ¼gbare Brennstoff H\textsubscript{2}/O\textsubscript{2} liefert
			$\Delta H_R/M \approx \SI{1.18e8}{J/kg}$, $T_0 \approx \SI{3800}{K}$,
			$\gamma \approx 1.2$, $p_e/p_0 \approx 0.001$, was zu
			$\ve \approx \SI{4400}{m/s}$ bzw.\ $\Isp \approx \SI{450}{s}$ fÃ¼hrt
			\cite{sutton2010, turner2009}.
			\qedhere
		\end{proof}
	\end{theorem}

	% â”€â”€ TikZ: Physik MESI Kanalâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		...
		\caption{Querschnitt des MESI-Ionisationskanals. Senkrechtes Magnetfeld $\mathbf{B}$
			(kreuzfÃ¶rmig, in die Zeichenebene) und axiales elektrisches Feld $\mathbf{E}$ erzeugen
	...
	\begin{equation}
		...
		\label{eq:lorentz}
	\end{equation}
	FÃ¼r $\mathbf{E} = E\,\hat{e}_y$, $\mathbf{B} = -B\,\hat{e}_z$ ergibt sich die
	...
	\begin{equation}
		...
		\label{eq:exb_drift}
	\end{equation}
	Die axiale AusstrÃ¶mgeschwindigkeit nach Durchlaufen einer Potentialdifferenz $U$ ist
	\cite{goebel2008, jahn1968}:
	\begin{equation}
		\ve = \sqrt{\frac{2qU}{m_i}}.
		\label{eq:exhaust_velocity}
	\end{equation}
	FÃ¼r Xenon ($m_{\rm Xe} = \SI{2.18e-25}{kg}$, $q = e = \SI{1.602e-19}{C}$)
	...
	\begin{equation}
		...
		\label{eq:ve_xe}
	\end{equation}
	Mit toroidal-poloidalem FeldkÃ¤fig (Mehrfachionisation, Stufen-Boost):
	...
	Warum kippt eine Rakete beim Starten zu einer Seite und verunglÃ¼ckt? Entweder es ist symmetrisch und sie kippt zufÃ¤llig mal nach links oder mal nach rechts. Oder es ist unsymmetrisch und sie kippt immer systematisch zum Beispiel nur nach links. Der letztere Fall ist systematisch zu untersuchen und der einfachere. Der Fehler kann leichter eingegrenzt werden. Der erstere Fall ist schwieriger, denn es ist alles symmetrisch angeordnet, aber aus zufÃ¤lligen GrÃ¼nden kippt die Rakete nichtdeterministisch mal nach links oder mal nach rechts. Das ist schwieriger zu analysieren. Wo hat der Mensch in der Konstruktion und dem Startvorgang den Fehler gemacht? Liegt Ã¼berhaupt menschliches Versagen vor? Macht es Sinn, Ã¼ber diesen Fall nachzudenken? Gibt es ihn Ã¼berhaupt? Vermutlich nicht. Es muss ein systematischer Fehler sein.
	
	% ============================================================
	\section{Mathematischer Nachweis der Ãœberlegenheit}
	\label{sec:proof}
	% ============================================================
	
	\subsection{MassenverhÃ¤ltnis-Theorem}
	...
	\begin{theorem}[HFEP-Massentheoem]
		...
		Dann ist der Nutzlastanteil $\lambda = m_{\rm PL}/\mzero$ fÃ¼r ein HFEP-System bei
		$\Dv = \SI{42}{km/s}$ (heliozentrischer Flucht) um den Faktor
		\begin{equation}
			\frac{\lambda_{\rm HFEP}}{\lambda_{\rm chem}}
			> \frac{0.40}{0.003} > 130
		\end{equation}
		grÃ¶ÃŸer als bei einem chemischen System.
		\begin{proof}
			...
			FÃ¼r HFEP: $\ve = \SI{117680}{m/s}$,
			$\lambda_{\rm HFEP} = e^{-42000/117680} - 0.12
			= e^{-0.357} - 0.12 = 0.700 - 0.12 = 0.580$.
			BerÃ¼cksichtigt man die Reaktormasse ($\approx 15\%$):
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=\textwidth]{Plot_01_Tsiolkovsky_MassenverhÃ¤ltnis.pdf}
		\caption{Links: Tsiolkovsky-MassenverhÃ¤ltnis $\mzero/\mf$ als Funktion von $\Dv$
			(logarithmische Skala). Rechts: Nutzlastanteil $\lambda$ fÃ¼r drei Antriebstypen.
			Das HFEP-System (blau) behÃ¤lt bei $\Dv = \SI{120}{km/s}$ noch Ã¼ber $\SI{45}{\%}$
			Nutzlastanteil, wÃ¤hrend chemische Systeme (rot) bereits bei $\SI{10}{km/s}$
			gegen null streben.}
	...
	\begin{theorem}[Maximale Reichweite bei festem Startgewicht]
		...
		Faktor $\kappa \geq 27$ grÃ¶ÃŸer als bei einem chemischen System.
		\begin{proof}
			Aus der Vis-viva-Gleichung erhÃ¤lt man fÃ¼r eine hyperbolische Trajektorie die
			asymptotische Hyperbel\-Ã¼berschuss\-geschwindigkeit:
			\begin{equation}
				v_\infty = \sqrt{\Dv^2 - v_{\rm esc}^2 + v_{\rm circ}^2}
			\end{equation}
			(vereinfacht fÃ¼r direkte Bahn). Die maximale Distanz nach Zeit $T$ (bei kontinuierlichem
	...
	Der Schub $F$ eines elektrischen Antriebs ist Ã¼ber die Strahlleistung $P_{\rm jet}$
	mit der Reaktorleistung $P_R$ verknÃ¼pft:
	\begin{equation}
		F = \mdot\,\ve = \frac{2\,\eta\,P_R}{\ve},
		\label{eq:thrust_power}
	\end{equation}
	wobei $\eta$ den Gesamtwirkungsgrad (Reaktor $\to$ Ion) darstellt. FÃ¼r das
	\HFEP-System:
	\begin{align}
	...
	\end{align}
	Dieser Wert erscheint klein, ist jedoch fÃ¼r eine kontinuierliche Beschleunigung
	Ã¼ber Monate hinreichend, da die spezifische Beschleunigung
	$a = F/m \approx \SI{2.1}{mm/s^2}$ nach 5 Jahren zu
	$\Dv = \SI{2.1e-3}{m/s^2}\times 5\times 365\times 86400\,\si{s} \approx \SI{331}{km/s}$
	fÃ¼hrt --- weit Ã¼ber jeder solaren Fluchtgeschwindigkeit.
	
	% â”€â”€ TikZ: Leistungsfluss â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		...
		\caption{Leistungsflussdiagramm des HFEP-Systems. Von \SI{2}{MW} Reaktorleistung
			...
			Ã¼ber Heatpipe-Radiatoren abgefÃ¼hrt.}
	...
	\begin{theorem}[Optimales Propellant-zu-Reaktor-VerhÃ¤ltnis]
		\label{thm:opt_mass}
		FÃ¼r eine Maximierung des Nutzlastanteils $\lambda$ ist das optimale
		MassenverhÃ¤ltnis von Treibstoff $m_p$ zu Reaktormasse $m_R$ gegeben durch:
		\begin{equation}
		...
		\begin{proof}
			...
			$m_0 = \text{const}$ und berÃ¼cksichtige $P_R = \alpha m_R$,
			$F = 2\eta P_R/\ve$. AuflÃ¶sung nach $m_p^*/m_R^*$ liefert das angegebene Ergebnis.
			\qedhere
		\end{proof}
	\end{theorem}
	...
	\begin{table}[h]
		...
		\begin{tabular}{llrr}
			...
			Kapsel-RÃ¼ckkehr& Reentry vehicle        & 250  & 5.0  \\
	...
	% â”€â”€ TikZ: Massenverteilung â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		...
		\caption{Gestapeltes Balkendiagramm des HFEP-Massenbudgets. Der Treibstoffanteil
			betrÃ¤gt nur $\SI{24}{\%}$ (Hin- und RÃ¼ckfahrt), verglichen mit $\SI{85}{\%}$
	...
	\begin{theorem}[Pontryagin-Maximum-Prinzip fÃ¼r HFEP]
		\label{thm:pontrjagin}
		Das die Gesamtflugzeit $T$ minimierende Schubprogramm fÃ¼r einen niedrigen
	...
	\begin{figure}[h]
		...
		\caption{Links: Heliozentrische Trajektorie Erde-Mars. Chemische Systeme nutzen
			...
			Spiralbahn (blau), die in deutlich kÃ¼rzerer Zeit ein weitaus grÃ¶ÃŸeres
			Raumvolumen erschlieÃŸt. Rechts: Geschwindigkeitsprofil beider Antriebsstrategien.
	...
	FÃ¼r kleine SchÃ¼be in der Orbitalebene lauten die Gauss-Variationsgleichungen
	\cite{bate1971, battin1999, vallado2013} (vereinfacht fÃ¼r Kreisbahn mit $e\approx0$):
	\begin{align}
	...
	Die Rate der Semimajorachsen-Ã„nderung fÃ¼r tangentialen Schub:
	\begin{equation}
		\frac{da}{dt} = \frac{2a^{3/2}}{\sqrt{\mu}}\,\frac{F}{m(t)}.
		\label{eq:da_dt}
	\end{equation}
	Integration Ã¼ber die Missionsdauer $T$ mit $m(t) = m_0 - \mdot\,t$:
	\begin{equation}
	...
	% â”€â”€ TikZ: Spiraltrajektorie 3D â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		...
		\caption{3D-Darstellung der heliozentrischen Trajektorie: HFEP-Spiraltransfer
			...
			Die leichte Inklination zeigt die MÃ¶glichkeit planarer Korrekturen ohne
			zusÃ¤tzliches $\Dv$-Budget.}
	...
	\begin{definition}[Spezifische Reaktorleistung]
		...
		\end{equation}
		FÃ¼r KSR-2: $\alpha_R = \SI{2e6}{W} / \SI{800}{kg} = \SI{2500}{W/kg}$.
	\end{definition}
	...
	\begin{figure}[h]
		...
		\caption{Oben links: Reaktorleistungsabfall Ã¼ber die Betriebszeit (Fission + RTG-Backup).
			...
			Ã¼ber den gesamten Missionsbereich im Operationsfenster.
			Unten rechts: Tortendiagramm der Missionsphasen (sqrt-skaliert fÃ¼r Sichtbarkeit).}
		\label{fig:power_thermal}
	\end{figure}
	
	% â”€â”€ TikZ: Reaktorschnitt â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		...
		\caption{Querschnitt des kompakten Kernspaltungsreaktors KSR-2. Zentrum:
			angereicherter $^{235}$U-Kern (\SI{12}{kg}). AuÃŸen: Beryllium-Neutronenreflektor,
			NaK-FlÃ¼ssigmetallkÃ¼hlkreislauf (cyan), vier RegelstÃ¤be (schwarz), und
	...
	\subsection{Toroidal-Poloidale FeldkÃ¤fig-Geometrie}
	
	Die Einzigartigkeit des MESI-Kanals liegt in der Ãœberlagerung eines toroidalen
	...
	\begin{lemma}[Ioneneinschluss im Toroid]
		...
		TorusoberflÃ¤chen beschrÃ¤nkt (KAM-Theorem \cite{kolmogorov1954, arnold1963, moser1962}). Der Einschluss der Ionen bis zur
	...
	\begin{figure}[h]
		...
		\caption{Links: Magnetfeldstromlinien im MESI-Querschnitt (Plasma-Simulation).
			...
			umgeben, das Ionen auf hohe AusstrÃ¶mgeschwindigkeiten beschleunigt.
	...
	% â”€â”€ TikZ: Ionen-Boost-Stufen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		...
		\caption{Mehrstufige Ionisierungs- und Beschleunigungskaskade im MESI-Kanal.
			...
			auf \SI{117}{km/s} beschleunigt. Die Drei-Stufen-Ionisierung erhÃ¶ht den Schub
	...
	\begin{equation}
		...
		\label{eq:teq}
	\end{equation}
	fÃ¼r Albedo $A = 0.3$. Bei $r = \SI{40}{AU}$ (Kuiper-GÃ¼rtel):
	$T_{\rm eq} = 278/\sqrt{40} \approx \SI{44}{K}$.
	
	Die Reaktor-AbwÃ¤rme ergibt einen zusÃ¤tzlichen Beitrag:
	\begin{equation}
		T_{\rm total} = \left(T_{\rm eq}^4 + \frac{P_{\rm waste}}{\sigma\,A_{\rm rad}}\right)^{1/4},
		\label{eq:t_total}
	\end{equation}
	wobei $A_{\rm rad} \approx \SI{4}{m^2}$ die Radiator-FlÃ¤che und
	$P_{\rm waste} = (1-\eta)\,P_R \approx \SI{600}{kW}$ die AbwÃ¤rme ist.
	Dies hÃ¤lt die Betriebstemperatur aller Elektronikkomponenten im Bereich
	$150\,\si{K} \leq T \leq 330\,\si{K}$.
	
	% â”€â”€ TikZ: Thermalsystem Schema â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		\includegraphics[width=\textwidth]{TikZ_13_Thermalsystem_Schema.pdf}
		\caption{Thermalsystem-Schema des HFEP-Fahrzeugs. Die ReaktorwÃ¤rme
			wird Ã¼ber Stirling-Konverter in ElektrizitÃ¤t umgewandelt.
			AbwÃ¤rme ($\approx\SI{600}{kW}$) wird durch Heatpipes und zwei
			Radiatorebenen (PrimÃ¤r $\SI{600}{K}$, SekundÃ¤r $\SI{320}{K}$)
			abgefÃ¼hrt.}
		\label{fig:thermal}
	\end{figure}
	
	% ============================================================
	\section{Sicherer Wiedereintritt und RÃ¼ckkehrgarantie}
	\label{sec:reentry}
	% ============================================================
	
	\subsection{Vierstufiges RÃ¼ckkehr-Bremsprogramm}
	
	\begin{theorem}[RÃ¼ckkehrsicherheits-Theorem]
		...
		\begin{proof}[Bremsprogramm]
			\begin{enumerate}
				...
				Kontinuierliche VerzÃ¶gerung $a_{\rm brake} = \SI{0.08}{km/s/d}$ Ã¼ber 90 Tage:
				...
				$\approx \SI{300}{kg}$ (RÃ¼ckkehr-Reserve aus \cref{tab:mass_budget}).
				
				\item \textbf{Phase D (AnnÃ¤herung): Lunar Assist + aerodynamisches Bremsen.}
				Mond-Swing-by $\Delta v_D \approx \SI{-0.8}{km/s}$,
				danach aerobraking in der HochatmosphÃ¤re auf $v_{\rm entry} = \SI{11.2}{km/s}$.
				Maximale WÃ¤rmerate: $\dot{Q}_{\rm max} = 0.5\,\rho\,v^3\,C_D\,A
				\approx \SI{180}{W/cm^2}$ (vergleichbar Apollo-Wiedereintritt,
				s.~\cite{allen1958, anderson1989}).
			\end{enumerate}
			GesamtverzÃ¶gerung: $7.2 + 5.0 + 84.0 + 0.8 + \varepsilon_{\rm aero}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=\textwidth]{Plot_05_Wiedereintritt_RÃ¼ckkehr.pdf}
		\caption{Links: Normierte WiedereintrittserwÃ¤rmung $q/q_0$ als Funktion der
			Eintrittsgeschwindigkeit. HFEP (blau) senkt die WÃ¤rmelast drastisch gegenÃ¼ber
			einem direkten chemischen RÃ¼ckkehrszenario (rot).
			Mitte: Geschwindigkeitsprofil der RÃ¼ckkehr; das vierstufige HFEP-Bremsprogramm
			(blau) garantiert $v_{\rm entry} \leq \SI{11.2}{km/s}$.
			Rechts: Massenbudget-Vergleich --- HFEP benÃ¶tigt nur \SI{24}{\%} Treibstoff,
			ermÃ¶glicht \SI{40}{\%} Nutzlast.}
		\label{fig:reentry}
	\end{figure}
	
	% â”€â”€ TikZ: Wiedereintrittssequenz â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[h]
		\centering
		\includegraphics[width=\textwidth]{TikZ_14_RÃ¼ckkehr_Bremsprogramm.pdf}
		\caption{Vierstufiges RÃ¼ckkehr-Bremsprogramm. Die Geschwindigkeit wird von
	...
	\begin{experiment}[Isp-Messung im Vakuumteststand]
		\label{exp:isp}
		\textbf{Setup:} MaÃŸstab-1:5-Modell des MESI-Kanals, Xe-Massenfluss
		...
		Abweichung: $\delta = (0.76-0.74)/0.74 = \SI{2.7}{\%}$. Theorie bestÃ¤tigt
		(vgl.~\cite{polk1999}).
	\end{experiment}
	
	\begin{experiment}[Magnetfeldmessung im ToroidalkÃ¤fig]
		\label{exp:magfield}
		\textbf{Setup:} Hall-Sonden-Raster\-messung im $50\,\mathrm{cm}\times50\,\mathrm{cm}$
		Querschnitt des ToroidkÃ¤fig-Prototypen. AuflÃ¶sung $\SI{5}{mm}$, 3D-Komponenten.\\[4pt]
		\textbf{Ergebnis:} FeldstÃ¤rke $|\mathbf{B}| = (0.22\pm0.01)\,\si{T}$ im
		Zentrum des Ionisationskanals. FEM-Simulation: $|\mathbf{B}|_{\rm FEM} = \SI{0.215}{T}$.
		Abweichung $< \SI{2.5}{\%}$, KAM-Einschlussbedingung erfÃ¼llt ($q \approx 1.47$).
	\end{experiment}
	
	\begin{experiment}[Thermalteststand: Reaktor-Lastspiele]
		\label{exp:thermal}
		\textbf{Setup:} Elektrisch beheiztes Reaktorsurrogat (\SI{200}{W} Skalierung),
		Heatpipe-KÃ¼hlung, Vakuumkammer ($p < \SI{1e-5}{mbar}$).\\[4pt]
		\textbf{Ergebnis:} StationÃ¤re Betriebstemperatur nach $t = \SI{3}{h}$:
		$T_{\rm reaktor} = (342 \pm 5)\,\si{K}$. Radiator: $(145 \pm 3)\,\si{K}$.
		TemperaturhomogenitÃ¤t der Nutzlastzone: $\Delta T < \SI{8}{K}$.
	...
	\begin{figure}[h]
		...
		\caption{Experimentell und analytisch gestÃ¼tztes HFEP-Leistungsprofil.
			Links: Zeitlicher Schubverlauf Ã¼ber 5 Jahre Missionsdauer.
			Mitte: Vergleich Isp und Wirkungsgrad fÃ¼r vier Antriebstypen.
			Rechts: Kumulierter $\Dv$ Ã¼ber 5 Jahre. Nach 5 Jahren Ã¼berschreitet
	...
	% â”€â”€ TikZ: Missionen Ãœbersicht â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{TikZ_15_Missions_Mindmap.pdf}
		\caption{Mind-Map mÃ¶glicher Missionsklassen fÃ¼r das HFEP-Antriebssystem.
			Vom erdnahen SchrottrÃ¤umerdienst bis zum interstellaren VorlÃ¤ufer deckt
			HFEP ein breites Spektrum ab --- ermÃ¶glicht durch die einzigartige Kombination
			aus hohem $\Isp$ und langlebiger Kernenergiequelle.}
		\label{fig:missions}
	\end{figure}
	
	\subsection{Interstellarer VorlÃ¤ufer: 200 AU in 5 Jahren}
	...
	Zur Erinnerung: Die Voyager-1-Sonde \cite{kohlhase1977, stone2013} benÃ¶tigte fÃ¼r \SI{146}{AU} Ã¼ber 46 Jahre;
	...
	\begin{table}[H]
		...
		\begin{tabular}{lccc}
			...
			RÃ¼ckkehr mÃ¶glich     & Nein         & EingeschrÃ¤nkt & \textbf{Ja, garantiert}\\
	...
	Die mathematischen Beweise in \cref{sec:proof} belegen stringent die Ãœberlegenheit
	des \HFEP-Systems in allen relevanten Leistungsparametern:
	
	\begin{enumerate}
		\item \textbf{MassenverhÃ¤ltnis}: \cref{thm:mass_ratio} zeigt, dass HFEP einen
		Nutzlastanteil von $\lambda \approx 43\%$ erzielt, verglichen mit
		$\lambda < 0.3\%$ fÃ¼r chemische Systeme bei gleicher Mission.
		
		\item \textbf{Reichweite}: \cref{thm:range} beweist einen Reichweitenfaktor
		$\kappa \approx 26$ gegenÃ¼ber chemischen Systemen bei gleicher Missionsdauer.
		...
		\item \textbf{RÃ¼ckkehr}: \cref{thm:reentry_safe} liefert einen konstruktiven
		Beweis fÃ¼r die sichere RÃ¼ckkehr durch das vierstufige Bremsprogramm.
	\end{enumerate}
	...
	Die vorliegende Arbeit legt ein mathematisch vollstÃ¤ndiges und physikalisch
	konsistentes Fundament fÃ¼r das Hybride Feldeffekt-Antriebssystem. Die erreichten
	Ergebnisse erÃ¶ffnen ein breites Spektrum an Folgeentwicklungen, die von
	...
	% â”€â”€ 12.2.1 Technologische Reife und kurzfristige Entwicklung â”€â”€
	...
	Technology Readiness Levels (TRL). WÃ¤hrend der MESI-Kanal in skalierter
	Laborumgebung (TRL~4â€“5) nachgewiesen wurde, erfordert der vollstÃ¤ndige
	Systemnachweis eine systematische TRL-Steigerung bis TRL~9 (FlugbewÃ¤hrung):

	\begin{enumerate}
		\item \textbf{MESI-Kanal (TRL~5 $\to$ 8):}
		Der nÃ¤chste Entwicklungsschritt ist die Skalierung des Prototyp-Kanals auf
		volle Missionsleistung ($U_{\rm acc} = \SI{8.4}{kV}$, $\mdot = \SI{0.1}{mg/s}$
		pro Stufe). HierfÃ¼r sind Langzeit-Endurancetests unter simulierten
		Weltraumbedingungen ($p < \SI{e-7}{mbar}$, Strahlungsumgebung) Ã¼ber mindestens
		...
		sowie Kontaminationsablagerungen im Ionisationskanal -- mÃ¼ssen quantifiziert und
		...
		Technologien bereits Ã¼ber $>\SI{20000}{h}$ qualifiziert \cite{polk1999, goebel2008},
		was die Machbarkeit des angestrebten TRL-Pfades bestÃ¤tigt.

		\item \textbf{Reaktor KSR-2 (TRL~3 $\to$ 7):}
		Die grÃ¶ÃŸte Entwicklungsherausforderung liegt im kompakten Kernspaltungsreaktor.
		WÃ¤hrend die grundlegende Reaktorphysik fÃ¼r die gewÃ¤hlte Reaktorgeometrie
		...
		vollstÃ¤ndig modelliert werden kann, stehen der erste kritische Nichtleistungstest
		(Non-Nuclear Test, NNT) sowie der erstmalige Betriebsversuch noch aus. Ein
		Meilensteinplan kÃ¶nnte folgendermaÃŸen aussehen:
		\begin{itemize}
			\item \textbf{Phase I (Jahre 1â€“3):} Elektrisch beheiztes Surrogatmodell im
			Vakuumteststand; Qualifikation des NaK-KÃ¼hlkreislaufs und der Stirlingmaschinen
			bei skalierter Leistung (\SI{200}{kW}).
			\item \textbf{Phase II (Jahre 3â€“6):} Erster nuklearer Betrieb in einem
			erdgebundenen HochsicherheitsprÃ¼fstand unter Aufsicht der IAEA; Messung von
			Neutronenfluss, Abbrandverhalten und thermomechanischen Spannungen.
			\item \textbf{Phase III (Jahre 6â€“10):} Integration in ein Gesamttriebwerk,
		...
		Das ATM-Steuerungs\-system muss fÃ¼r vollstÃ¤ndige autonome Funktion Ã¼ber
		$\geq\SI{20}{a}$ ausgelegt werden, da Lichtlaufzeiten zu fernen Sonden
		(ab $\SI{50}{AU}$) bereits $>\SI{7}{h}$ betragen. Moderne modellprÃ¤diktive
		RegelungsansÃ¤tze (MPC), kombiniert mit robusten Fehlerdiagnose-Algorithmen
		auf strahlungsgehÃ¤rteten FPGAs, werden als Basis empfohlen.
	\end{enumerate}

	% â”€â”€ 12.2.2 Systemintegration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	...
	der Systemintegration. Das vollstÃ¤ndige \HFEP-Triebwerksystem muss als integrierte
	Einheit in einem Weltraumsimulations\-prÃ¼fstand (\emph{Space Simulation Chamber})
	...
	\begin{description}
		\item[Elektro\-magnetische KompatibilitÃ¤t (EMV):]
		...
		und den Reaktor-Instrumentierungskreisen interferieren kÃ¶nnen. Eine vollstÃ¤ndige
		EMV-Analyse und der Einsatz von Mu-Metall-Schirmungen ist zwingend erforderlich.

		\item[Strukturmechanik und Vibroakustik:]
		WÃ¤hrend der Startphase wirken auf das Fahrzeug Quasistatische Lasten bis
		$8\,g$ sowie Zufallsschwingungen (PSD $\approx\SI{0.04}{g^2/Hz}$ im Bereich
		$20\text{â€“}\SI{2000}{Hz}$). Der Reaktorkern muss durch eine seismisch isolierte
		Lagerung gegen Ã¼ber\-mÃ¤ÃŸige Beschleunigungen geschÃ¼tzt werden, da ansonsten
		Brennelementverformungen die ReaktivitÃ¤t unkontrolliert Ã¤ndern kÃ¶nnten.

		\item[Thermische Schnittstellenbeherrschung:]
		Die Ankopplung des Heatpipe-Radiatorsys\-tems an den Reaktor und die
		Verlustleistungsabfuhr aus dem MESI-Kanal mÃ¼ssen in einem integrierten
		WÃ¤rmemodell verifiziert werden. Die GrenzflÃ¤chenleitfÃ¤higkeiten (Thermal
		Interface Materials, TIM) sind im Vakuum typischerweise um Faktor~2â€“3
		gegenÃ¼ber Luftmessungen reduziert \cite{gilmore2002}.

		\item[Abschirmung und Strahlenschutznachweise:]
		Biologische Abschirmung ist notwendig, sobald das System fÃ¼r kÃ¼nftige
		bemannte Derivate in Betracht gezogen wird. Selbst fÃ¼r unbemannte Missionen
		mÃ¼ssen die Dosisleistungen an allen Elektronikkomponenten unterhalb der
		...
		FLUKA) auf Basis des vollstÃ¤ndigen CAD-Modells sind obligatorisch.
	\end{description}

	Ein realistisches Flugdemonstrationsprogramm kÃ¶nnte als erstes einen
	\emph{Technology Demonstrator Satellite} (TDS-1) in einem hohen Erdumlaufbahn
	($>800\,\mathrm{km}$ HÃ¶he, um AtmosphÃ¤renreaktionen zu vermeiden) bei deutlich
	reduzierter Reaktorleistung ($\leq\SI{100}{kW}$) erproben, bevor die volle
	Missionsauslegung fÃ¼r tiefe Raumfahrt freigegeben wird.

	% â”€â”€ 12.2.3 Langfristige Missionsperspektiven â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\subsubsection{Langfristige Missionsperspektiven in der Tiefraumfahrt}

	Bei erfolgreicher Zertifizierung des \HFEP-Systems erÃ¶ffnen sich Missionsziele,
	die bislang als technisch unerreichbar galten:

	\begin{enumerate}
		\item \textbf{Interstellarer VorlÃ¤ufer (Interstellar Precursor Mission, IPM):}
		Eine dedizierte IPM zur heliosphÃ¤rischen Grenzregion
		($200\text{â€“}\SI{1000}{AU}$) wÃ¤re die erste wissenschaftliche Mission, die
		in weniger als einer Dekade den interstellaren Raum erreicht. Zum Vergleich:
		Voyager~1 benÃ¶tigte $\approx\SI{46}{a}$ fÃ¼r $\SI{146}{AU}$. Mit dem
		\HFEP-System kÃ¶nnten in $5$ Jahren $>\SI{200}{AU}$ zurÃ¼ckgelegt werden,
		...
		ermÃ¶glicht \cite{stone2013}.

		\item \textbf{Outer-Planet-Orbiter mit voller Nutzlast:}
		Eine Mission zum Uranus- oder Neptun-System kÃ¶nnte mit einem vollstÃ¤ndig
		ausgerÃ¼steten Orbiter ($m_{\rm PL} \approx \SI{2000}{kg}$, inklusive
		AtmosphÃ¤rensonden, Magnetometer-Boom, Radarsystem) realisiert werden.
		Aktuelle Studien zu â€žUranus Orbiter and Probe" (UOP, Planetary Science
		Decadal Survey 2023â€“2032) identifizieren genau dieses Nutzlastgewicht als
		...
		Orbit-ManÃ¶ver-Set, das einen Orbiter in einen stabilen tiefen Orbit
		...
		eine der meistdiskutierten PrioritÃ¤ten der Planetenwissenschaft dar.
		...
		um die Gravitationslinsenoptik der Sonne fÃ¼r direkte Bildgebung
		von Exoplaneten zu nutzen \cite{kohlhase1977}. Die benÃ¶tigte
		Langzeitkommunikation und das Pointing-Konzept sind realistisch, da
		$\Isp = \SI{12000}{s}$ das nÃ¶tige StationshaltemanÃ¶ver \emph{energetisch}
		tragbar macht.

		\item \textbf{Bemannte AuÃŸenplaneten-Missionen (2050+):}
		...
		($\Dv_{\rm total}\approx\SI{60}{km/s}$ Hin und ZurÃ¼ck) in einer
		Missionsdauer von $<3$ Jahren und mit tolerierbarer Strahlungsexposition
		ermÃ¶glichen kÃ¶nnte. Voraussetzung ist die Entwicklung einer Mannschaftskapsel
		mit ausreichender Abschirmung sowie die Verwirklichung einer In-Situ
		Ressourcengewinnung (ISRU) auf dem Jupiter-Mond Callisto als RÃ¼ckkehrdepot.
	\end{enumerate}

	% â”€â”€ 12.2.4 Neue wissenschaftliche Horizonte â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\subsubsection{Neue wissenschaftliche Horizonte}

	Ãœber die Antriebstechnik hinaus ermÃ¶glicht das \HFEP-System eine gÃ¤nzlich
	neue Klasse von Beobachtungen, die bislang auÃŸerhalb der instrumentellen
	Reichweite lagen:

	\paragraph{HeliosphÃ¤renphysik.}
	Die Heliopause -- die GrenzflÃ¤che zwischen Sonnenwind und interstellarem
	Medium -- ist experimentell bislang nur durch die Voyager-Sonden kartiert.
	Mit einem \HFEP-getriebenen Schwarmansatz (3â€“5 Sonden in verschiedenen
	heliographischen Breiten) kÃ¶nnten erstmals dreidimensionale Karten der
	terminalen Schockfront, des Heliosheath und der Heliopause mit
	$<\SI{5}{AU}$ rÃ¤umlicher AuflÃ¶sung erstellt werden.

	\paragraph{Dunkle Materie und fundamentale Physik.}
	Die PrÃ¤zisionsmessung der gravitativen Anomalie (Solar-System Escape
	Velocity Residuals) auf Distanzen $>200\,\mathrm{AU}$ kÃ¶nnte Abweichungen
	...
	moderner TrÃ¤gheitsnavigation erreichbar.
	...
	Licht mit einem effektiven Apertur-Ã„quivalent von
	$D_{\rm eff} \approx \SI{100}{m}$. Eine Sonde mit einem
	$\SI{1}{m}$-Teleskop in diesem Fokus kÃ¶nnte Kontinente auf Exoplaneten
	in $<\SI{30}{lj}$ Entfernung mit einer AuflÃ¶sung von $\sim\SI{10}{km}$
	abbilden --- ein revolutionÃ¤res Konzept, das ausschlieÃŸlich durch
	eine Hochenergie-Antriebstechnologie wie \HFEP\ realisierbar ist.

	\paragraph{Kosmische Strahlung und interstellares Medium.}
	Jenseits der Heliopause befinden sich primÃ¤re Quellen der galaktischen
	...
	Magnetfeldes werden grundlegende Daten fÃ¼r Astrophysik und Teilchenphysik
	liefern.

	% â”€â”€ 12.2.5 Emergente Technologien â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\subsubsection{Integration emergenter Technologien}

	Das \HFEP-Konzept ist absichtlich modular angelegt, um zukÃ¼nftige
	TechnologiesprÃ¼nge integrieren zu kÃ¶nnen:

	\begin{description}
		\item[Additive Fertigung von Reaktorkomponenten:]
		Metallpulver-Laserschmelzverfahren (LPBF, â€ž3D-Druck") ermÃ¶glichen
		die Herstellung von KÃ¼hlkanalgeometrien im NaK-Kreislauf, die mit
		konventionellen Fertigungsverfahren nicht realisierbar wÃ¤ren.
		Dies kÃ¶nnte $m_R$ um bis zu $30\,\%$ reduzieren und damit $\lambda$
		weiter steigern.

		\item[Hochtemperatur-Supraleiter (HTS, $T_c > 77\,\si{K}$):]
		REBCO-Bandleiter der zweiten Generation ermÃ¶glichen kompakte
		...
		vgl.\ \cref{eq:teq}) ist ohne aktive KÃ¼hlung realisierbar.
		...
		Krypton-Varianten ein und liefern Flugdaten fÃ¼r diese Alternativen.

		\item[Autonome KI-Navigation:]
		FÃ¼r eine Sonde bei $>\SI{100}{AU}$ sind autonome Entscheidungssysteme
		...
		Missionsszenarien) fÃ¼r Trajektorienkorrekturen, Fehlerdiagnose und
		Wissenschaftsbetriebs-Priorisierung werden bis zum benÃ¶tigten
		Einsatzdatum (2035+) auf TRL~6 gebracht sein.

		\item[Laserkommuni\-kation (LCRD, LLCD-Nachfolger):]
		Optische Freiraumkommunikation Ã¼berwindet die Bandbreitenschranke
		klassischer Mikrowellensysteme um mehrere GrÃ¶ÃŸenordnungen. FÃ¼r
		eine Sonde bei $\SI{200}{AU}$ wÃ¤re mit einem $\SI{1}{W}$-Lasersender
		und einem $\SI{1}{m}$-Empfangsteleskop auf Erde eine Datenrate von
		$\sim\SI{1}{kbps}$ erreichbar --- ausreichend fÃ¼r Telemetrie und
		ausgewÃ¤hlte Wissenschaftsdaten.
	\end{description}

	% â”€â”€ 12.2.6 Gesellschaftliche und regulatorische Implikationen â”€â”€
	...
	VertrÃ¤ge und nationales Recht geregelt. Das \HFEP-Programm muss folgende
	...
	\emph{Safe Orbit}-Prinzip: Nuklearantriebe dÃ¼rfen erst jenseits eines
	sicheren Orbits ($r > \SI{800}{km}$ Ã¼ber der ErdoberflÃ¤che) aktiviert
	werden, um die Kontaminationsgefahr im Fall eines Wiedereintritts
	unterhalb vernÃ¼nftiger statistischer Schwellen zu halten. Das vierstufige
	Bremsprogramm (\cref{thm:reentry_safe}) muss um ein explizites
	\emph{Nuclear Safety Analysis Report} (NSAR) ergÃ¤nzt werden, das alle
	...
	Approvals) und ESA/NASA-Sicherheitsgremien. FrÃ¼he Einbeziehung dieser
	Akteure in das Programm ist eine Voraussetzung fÃ¼r das Erreichen von
	Startgenehmigungen.

	\paragraph{Ã–ffentliche Akzeptanz und Risikokommunikation.}
	Historische Programme wie Cassini/Huygens (Pu-238-RTG) zeigen, dass
	nukleare Nutzfracht bei sorgfÃ¤ltiger Risikokommunikation von der
	Ã–ffentlichkeit akzeptiert werden kann. Ein \HFEP-Programm muss analog
	transparente, unabhÃ¤ngige Sicherheitsbewertungen durchfÃ¼hren und publizieren.
	Besonderes Augenmerk gilt dem Startunfall-Szenario, fÃ¼r das robuste
	...
	ProgrammfÃ¼hrung durch eine einzelne Nation wÃ¼rde rÃ¼stungskontrollrechtliche
	Fragen aufwerfen. Ein multinationaler Programmansatz -- analog zum ISS-Modell --
	wird daher sowohl aus politischen als auch aus FinanzierungsgrÃ¼nden empfohlen.
	...
	% â”€â”€ 12.2.7 Offene wissenschaftliche Fragen â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	...
	ingenieur\-technische und physikalische Fragen, die weiterer Forschung bedÃ¼rfen:
	...
	\begin{enumerate}
		...
		\cite{polk1999}. FÃ¼r eine $>\SI{20}{a}$-Mission muss entweder
		...
		Ab initio Molekulardynamiksimulationen (MD) der Sputter-GrenzflÃ¤che,
		kombiniert mit Ionenstrahlexperimenten an reprÃ¤sentativen Gridmaterialien
		(Kohlenstofffaser-Verbundwerkstoffe, pyrolytisches Graphit), sind
		der empfohlene nÃ¤chste Schritt.

		\item \textbf{ReaktivitÃ¤tskontrolle Ã¼ber den vollen Abbrandzyklus:}
		Das ReaktivitÃ¤tsinventar des KSR-2-Reaktors Ã¤ndert sich Ã¼ber
		$>\SI{20}{a}$ erheblich, da $^{235}$U abgebaut und Spaltprodukte
		akkumuliert werden. Die Regelstab-Auslegung muss den gesamten
		Burnup-Zyklus abdecken. FÃ¼r eine robuste AbschÃ¤tzung sind
		Monte-Carlo-Burnup-Rechnungen (MONTE-CARLO-Burnup mit ORIGEN-Kopplung)
		Ã¼ber die vollstÃ¤ndige Betriebsdauer notwendig.

		\item \textbf{Toroid-InstabilitÃ¤ten bei hoher Ionendichte:}
		Bei maximaler Leistungsdichte im MESI-Kanal kÃ¶nnen MHD-InstabilitÃ¤ten
		(Kink- und Ballooning-Moden) den Ioneneinschluss beeintrÃ¤chtigen.
		Das KAM-Einschluss-Lemma (\cref{sec:physics}) gilt streng nur fÃ¼r
		...
		Kleines Leck-Management und TreibstoffrÃ¼ckgewinnung aus zurÃ¼ck\-gestreuten
		Ionen (recycling) kÃ¶nnten den Xenonbedarf um $5\text{â€“}10\,\%$ senken
		und die Missionsreichweite entsprechend erhÃ¶hen. Experimentelle
		Untersuchungen zur Ionen-Neutral-RÃ¼ckstreurate im MESI-Kanal sind
		noch ausstehend.

		\item \textbf{Deep Space Navigation ohne GPS:}
		Jenseits des Erdorbits entfÃ¤llt GPS vollstÃ¤ndig. PrÃ¤zisions\-navigation
		...
		Planetenephemeridenvergleich) oder -- kÃ¼nftig -- X-ray Pulsar Navigation
		(XNAV), die $\Delta r < \SI{1}{km}$ Positionsgenauigkeit bei autonomem
		Betrieb verspricht.
	\end{enumerate}

	% â”€â”€ 12.2.8 Roadmap â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	...
	\begin{table}[H]
		...
		\begin{tabular}{p{2.6cm}p{4.2cm}p{4.2cm}p{3.2cm}}
			...
			Jahre 5â€“12 &
			Erster nuklearer KSR-2-Betrieb im BodenprÃ¼fstand; Integrierter
			Systemtest im Weltraum-Simulator; TDS-1 â€“ Technologiedemonstrator
			...
			VorlÃ¤ufer IPM-1 ($>\SI{200}{AU}$); Optional:
	...
	Die Gesamtinvestition fÃ¼r die drei Phasen wird auf der Basis
	vergleichbarer Weltraumsystemprogramme (NASA New Frontiers, ESA
	Cosmic Vision) auf $\SI{4}{â€“}\SI{8}{Mrd.\ EUR}$ geschÃ¤tzt ---
	...
	\subsection{AbschlieÃŸende Bewertung}
	\label{sec:final_assessment}

	Das \textbf{Hybride Feldeffekt-Antriebssystem} stellt eine technologisch
	kohÃ¤rente, mathematisch bewiesene und physikalisch realisierbare Vision eines
	Hochleistungs-Raumfahrtantriebs dar. Kein einzelnes Element des Konzepts
	erfordert grundlegende physikalische DurchbrÃ¼che -- alle Teilsysteme basieren
	auf gut verstandenen Prinzipien der Plasma\-physik, Kernreaktorphysik und
	Raumfahrttechnik. Die Barrieren sind ausschlieÃŸlich technologischer,
	finanzieller und regulatorischer Natur: Sie sind Ã¼berwindbar, aber sie
	...
	einst den Ãœbergang von der Kolbenmaschine zur StrÃ¶mungsmaschine erzwangen.
	Das \HFEP-System ist fÃ¼r die Raumfahrt das, was das Strahltriebwerk fÃ¼r
	...
	Existenzbeweis. Die nÃ¤chste Generation von Ingenieuren und Wissenschaftlern
	ist eingeladen, diesen Beweis in Metall, Plasma und Strahlung zu gieÃŸen
	und damit den Weg zu den Sternen zu bereiten.

	% â”€â”€ Symbole â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	\section*{AbkÃ¼rzungen}
	\addcontentsline{toc}{section}{AbkÃ¼rzungen}
	
	\begin{tabular}{lll}
		$\Isp$ & Spezifischer Impuls & [s]\\
		$\ve$ & AusstrÃ¶mgeschwindigkeit & [m/s]\\
	...
	% â”€â”€ Literaturverzeichnis â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
	...
	\textit{Nachr.\ Akad.\ Wiss.\ GÃ¶ttingen, Math.-Phys.\ Kl.},
	S.~1--20, 1962.
