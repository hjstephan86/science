...
from array2d_core import Array2D
...
def solve_system(a, b, n):
    for j in range(2, n + 1):
        b[j] -= a.__getcall__(j,0) * b[j-1]

    b[n] /= a.__getcall__(n,1)

    for j in range(n - 1, 0, -1):
        b[j] -= a.__getcall__(j,2) * b[j+1]
        b[j] /= a.__getcall__(j,1)
