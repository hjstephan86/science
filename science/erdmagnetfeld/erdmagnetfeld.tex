...
ErdbebenvorlÃ¤ufer (ULF)   & $1$--$10\,\mathrm{nT}$    & Sekunden       & Umstritten \\
...
\label{bsp:sekular}
    ...
    SpulenflÃ¤che $A = 1\,\mathrm{km}^2 = 10^6\,\mathrm{m}^2$, $N = 1$.
...
\begin{satz}[MindestflÃ¤che fÃ¼r s\"akulare Variation]
...
\begin{satz}[MindestflÃ¤che bei geomagnetischem Sturm]
...
f\"ur beide Szenarien als Funktion der SpulenflÃ¤che logarithmisch dar.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{plot2_spannung_flaeche.pdf}
    \caption{Induzierte Spannung als Funktion der SpulenflÃ¤che f\"ur
...
Inspired by der drahtlosen EnergieÃ¼bertragung (Wireless Power Transfer, WPT)
...
ResonanzÃ¼berhÃ¶hung um den G\"utefaktor $Q$:
\[
...
Die Magnetfeldvariationsrate ist in PolnÃ¤he erhÃ¶ht, da:
\begin{enumerate}
    ...
    \item MagnetosphÃ¤risch-ionosph\"arische Kopplung in PolnÃ¤he st\"arker ist
\end{enumerate}
Kanadische und skandinavische Forschungseinrichtungen (z.\,B.\ TromsÃ¸,
...
erfahren auch proportional stÃ¤rkere absolute Schwankungen. Induktionssysteme
...
\begin{itemize}
    ...
    \item Quantifizierung des Beitrags induzierter Str\"ome in leitenden
          Gesteinsschichten zur scheinbaren Verst\"arkung oder AbschwÃ¤chung
          des Oberfl\"achenfeldes (Tellurik-Effekte)
    \item Nichtlineare Effekte bei sehr gro{\ss}en Variationsamplituden
          (KernsÃ¤ttigung von Ferritkernen in gro{\ss}en Spulen)
