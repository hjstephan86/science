...
\begin{definition}[Ged\"ampfte Schwingung]
    ...
    \]
    Der Faktor $e^{-\lambda t}$ hei\ss{}t \emph{EinhÃ¼llende} der Schwingung.
\end{definition}
...
\begin{figure}[h!]
    ...
    bei minimalem TreibhausgasausstoÃŸ. Datengrundlage: IPCC 2014, IEA 2023.}
    \label{fig:plot4}
\end{figure}
...
\label{satz:sonne}
    ...
    SonnenhÃ¶chststand zum Zeitpunkt $t_0$ wird durch die Gau\ss{}sche Energiefunktion
    modelliert:
    \[
...
\begin{figure}[h!]
    ...
    Sonnenaufgang, SonnenhÃ¶chststand und Sonnenuntergang sind markiert.
...
\label{satz:gedaempft}
    ...
    \begin{enumerate}
        \item Die EinhÃ¼llende $e^{-\lambda t}$ und ihre Negation $-e^{-\lambda t}$
...
\begin{figure}[h!]
    ...
    verschiedene D\"ampfungskonstanten $\lambda$, mit gestrichelten EinhÃ¼llenden
...
\begin{itemize}
    ...
    \item \textbf{Satz~\ref{satz:gedaempft}}: Die ged\"ampfte Schwingung ber uhigt
          ...
          EinhÃ¼llende -- das Negationsprinzip in periodischen Systemen.
\end{itemize}
...
\textbf{Regelungstechnik:} In der Systemtheorie ist die \emph{komplementÃ¤re
...
endlichen PrÃ¤dikate beschreibt. Meister Eckhart formulierte: \emph{``Gott ist das
