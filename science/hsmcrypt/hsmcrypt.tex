...
\begin{table}[h]
	...
	\begin{tabular}{@{}lll@{}}
		...
		\texttt{HSM\_PARAM[0..7]} & 8Ã—32 Bit & Funktionsparameter ($n$, Schlüsselhandle, Adresszeiger) \\
		\texttt{HSM\_RESULT[0..15]} & 16Ã—32 Bit & Ergebnispuffer (Signatur, Chiffrat, Statuscode) \\
