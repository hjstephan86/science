...
das Plancksche Wirkungsquantum $h$ quantifiziere â€ždie kleinste mögliche Wirkung (Energie $\times$ Zeit)
...
Die physikalische Größe â€žWirkung" (engl.\ \emph{action}), definiert als das Zeitintegral der
Lagrange-Funktion
\begin{equation}
