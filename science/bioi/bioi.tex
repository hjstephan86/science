...
verbindet evolutionÃ¤re Distanzen mit LCS-Werten auf Signatur-Arrays.
\end{abstract}
...
\begin{itemize}
    ...
    \item $w_{\mathrm{akt}}(k_i, k_j)$: AktivierungsstÃ¤rke.
\end{itemize}
\end{definition}
...
\]
d.\,h.\ der LCS-Wert liefert eine untere Schranke f\"ur die SequenzÃ¤hnlichkeit.
\end{satz}
...
Unten rechts: Phylogenetischer Graph mit evolutionÃ¤ren Distanzen als Kantengewichte.}
...
\]
erm\"oglicht Echtzeit-Erkennung neuer AusbrÃ¼che:
...
LeukÃ¤mie via Subgraph-Pharmakophor-Screening.
...
in \emph{allen} bekannten VirusstÃ¤mmen enthalten ist
...
\begin{enumerate}[label=(\roman*)]
    ...
    \item \textbf{Genomnetzwerke} (modulare Struktur, Cluster von Genen):
          Spektrum hat ausgeprÃ¤gte \emph{Spektrall\"ucke}
...
Tumorsuppressor-Gene wie TP53 (WÃ¤chter des Genoms) sind biologisch
...
Der formale Beweis bestÃ¤tigt die biologische Intuition.
\end{proof}
...
Universit\"at Bielefeld.
\url{https://github.com/hjstephan86/science/tree/main/science/dnastor}
