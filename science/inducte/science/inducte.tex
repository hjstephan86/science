...
Orbitalhöhe von rund \SI{100}{\kilo\metre} -- die sogenannte \emph{KÃ¡rmÃ¡n-Linie}
...
Untersuchungen zur \emph{KÃ¡rmÃ¡n'schen Wirbelstraße} zurück:

\begin{itemize}
  \item \textbf{von KÃ¡rmÃ¡n (1911):} Str\"omungsinstabilit\"aten hinter stumpfen
...
Thermosphäre beschreibt. An der KÃ¡rmÃ¡n-Linie ($h = \SI{100}{\kilo\metre}$) ergibt
...
Die \emph{KÃ¡rmÃ¡n'sche Wirbelstraße} hinter zylindrischen Hindernissen hat die
Strouhal-Frequenz:

\begin{equation}
  f_{\text{KÃ¡rmÃ¡n}} = St \cdot \frac{v}{d}, \qquad St \approx 0.20
  \label{eq:strouhal}
\end{equation}

Bei $v = 130\,\text{km/h} = 36.1\,\text{m/s}$ und $d = 0.05\,\text{m}$:
\begin{equation}
  f_{\text{KÃ¡rmÃ¡n}} = 0.20 \cdot \frac{36.1}{0.05} = \SI{144}{\hertz}
...
Die Eigenfrequenz der Induktionsfeder muss auf die KÃ¡rmÃ¡n-Wirbelfrequenz
(Gl.~\eqref{eq:strouhal}) abgestimmt werden:

\begin{equation}
  \omega_0 = 2\pi f_{\text{KÃ¡rmÃ¡n}} = 2\pi \cdot St \cdot \frac{v}{d}
\end{equation}
...
\begin{beispiel}[Auslegung für 100\,km/h]
  ...
  \begin{align}
    f_{\text{KÃ¡rmÃ¡n}} &= 0.20 \cdot \frac{27.8}{0.05} = \SI{111}{\hertz} \\
...
(typisch $\sigma = 0.60$--$0.78$ für PKW-Kühlergrills nach Idel'Äik,
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{KÃ¡rmÃ¡n-Wirbelfrequenz ermitteln} (wählbarer Zylinderdurchmesser $d$):
        \begin{equation}
...
\begin{figure}[H]
  ...
  \caption{%
    ...
    fällt um mehr als sechs Größenordnungen. Bei 100\,km (KÃ¡rmÃ¡n-Linie) liegt
...
\begin{figure}[H]
  ...
  \caption{%
    ...
    KÃ¡rmÃ¡n-Wirbelfrequenz -- bei 100\,km/h optimal: $k^* \approx 16\,\text{kN/m}$,
...
\begin{itemize}
  \item Interferenzeffekte zwischen benachbarten Wirbelkörpern im Array
        (konstruktive oder destruktive Interferenz der KÃ¡rmÃ¡n-Wirbel).
