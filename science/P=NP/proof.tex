...
Ziel: Mache aus 8 Knoten wieder 6 Knoten mit gleicher KantenlÃ¤nge in polynomieller Zeit.\newline
Idee: Berechne dazu die Restklasse 6.\newline
Jeder Knoten berechnet eine Funktion $f(b_1, \ldots, b_n) = \{0, \ldots, 9\}$, $b_i \in \{0, 1\}$.\newline
Bei HinzufÃ¼gen zwei neuer Knoten erhÃ¶ht sich die Wertemenge des vorhandenen Graphen um maximal $18\equiv 0 \mod 6$.

Man dachte, das Problem P sei NP-vollstÃ¤ndig. Da dieses Problem aber in polynomieller Zeit lÃ¶sbar ist, ist es echt in $P$. 
\end{document}
