...
Das Vorgehen zur Umgestaltung: Erstelle ein neues Python Modul für jede Ebene der Vererbungshierarchie. Dazu wird nur Code zum Softwaresystem hinzugefügt und kein Code gelöscht. Die neuen Python Module enthalten dann alle neuen Klassen, die es aber im Projekt schon geben muss. Sonst würden sie nicht erstellt werden. Jetzt gilt es nur noch, die alten Python Klassen der Vererbungshierarchie, für die neue erstellt worden sind, zu entfernen. Diese einfache Umgestaltung erhält das ganze Verhalten des Systems und bildet gleichzeitig die Vererbungshierarchie horizontal ab.
...
\textit{Die Wahrheit steht immer im Code. UML-Diagramme sind keine eigenständigen
Artefakte, die gepflegt werden müssen -- sie sind \textbf{abgeleitete Sichten auf den Code}. Jedes Diagramm, das nicht automatisch aus dem aktuellen
