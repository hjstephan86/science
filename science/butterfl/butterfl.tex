...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{Schematische Darstellung der Flügelanatomie eines Tagfalters.
			...
			nach Comstock-Needham: Costa, Subcosta, Radius (R1â€“R5), Media (M1â€“M3),
			Cubitus (Cu1â€“Cu2) und Analader (A). Gestrichelt: eine transversale Querader,
	...
	\begin{proof}
		...
		klassische Thin-Airfoil-Theorie (Munk 1922, von KÃ¡rmÃ¡n und Burgers 1935)
	...
	\begin{figure}[H]
		...
		\caption{Flughöhenprofil des Monarch-Falters (\textit{Danaus plexippus})
			...
			zentralen Hochebene Mexikos), fällt dann zu den Überwinterungswäldern in MichoacÃ¡n
	...
	\begin{figure}[H]
		...
		\caption{\textbf{Links:} Schematische Migrationsroute des Monarch-Falters
			von Ontario (Kanada) nach MichoacÃ¡n (Mexiko), farbkodiert nach Flughöhe.
...
Ausblick (Abschnitt~\ref{sec:ausblick}) vertieft wird.
	...
	Die aerodynamischen Vorteile des Schmetterlingsfluges â€“ insbesondere der
	LEV-Mecha\-nismus, die adaptive Flügeldeformation und der clap-and-fling-Impuls â€“
	...
	dass die Überwinterungswälder in MichoacÃ¡n bis 2080 unter optimistischen
