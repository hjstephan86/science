...
\"uber \textbf{40 Millionen TodesfÃ¤lle} verursacht~\cite{bekker2023hiv}. Ende 2023 lebten
...
AIDS-bedingte TodesfÃ¤lle pro Jahr. Die Einf\"uhrung der kombinierten antiretroviralen
...
Der Verlauf einer HIV-Infektion ohne Therapie lÃ¤sst sich in drei Phasen unterteilen:

\begin{enumerate}
\item \textbf{Akute Phase} (Wochen 1--6): Rasche virale Replikation, hohe Viruslast,
      transiente Reduktion der CD4$^+$ T-Zellzahl, grippeÃ¤hnliche Symptome.
...
\begin{itemize}
\item Wie infiziert HIV-1 Wirtszellen Ã¼ber CD4, CCR5 und CXCR4?
...
\item Wie lÃ¤sst sich die epidemische Ausbreitung formal kontrollieren?
\end{itemize}

\subsection{Motivation}

Das formale VerstÃ¤ndnis der HIV-Dynamik ist aus mehreren Gr\"unden essenziell:
...
\begin{enumerate}
\item \textbf{Adsorption}: Das HÃ¼llprotein gp120 bindet an den CD4-Rezeptor.
...
\item \textbf{Fusion}: Das HÃ¼llprotein gp41 vermittelt die Fusion der viralen HÃ¼lle
...
\item \textbf{Reverse Transkription}: Die virale Reverse Transkriptase (RT) synthetisiert
      aus der ssRNA eine doppelstrÃ¤ngige DNA (dsDNA).
...
\item \textbf{Transkription und Translation}: Das Provirus wird durch zellulÃ¤re und virale
...
\item \textbf{Reifung und Knospung}: Neue Virionen knospen aus der Zellmembran;
      die virale Protease spal-tet Gag- und Gag-Pol-VorlÃ¤ufer zur Reifung.
\end{enumerate}
...
% =============================================================================
\section{Formale Analyse: Reproduktionszahl und StabilitÃ¤tssÃ¤tze}
% =============================================================================
...
Rund 1{,}3 Millionen Neuinfektionen und 630.000 AIDS-bedingte TodesfÃ¤lle wurden
...
\item \textbf{Parenteral}: IntravenÃ¶ser Drogengebrauch (Nadelteilen);
...
Zellen vollst\"andig zu eliminieren. AnsÃ¤tze hierfÃ¼r umfassen:
...
\item \textbf{CRISPR-Cas9 und Gentherapie}: CRISPR-basierte Systeme k\"onnen das Provirus
      ...
      HIV-infizierten MÃ¤usen und Affen gezeigt. Klinische Phase-I-Studien am Menschen
      laufen seit 2022.
...
ungelÃ¶sten Herausforderungen der Biomedizin. Die Schwierigkeiten sind fundamental:
\begin{enumerate}
...
\item \textbf{Immune Evasion}: Das Env-Trimer ist dicht mit N-gebundenen Glykanen
      bedeckt (``glycan shield''), die AntikÃ¶rperziele maskieren.
\item \textbf{Fehlendes Tiermodell}: Schimpansen infizieren sich mit HIV-1,
      erkranken aber nicht; Makakenmodelle nutzen SHIV (chimÃ¤res SIV/HIV),
...
\begin{itemize}
\item \textbf{Cabotegravir + Rilpivirin intramuskulÃ¤r}: Seit 2021 in den USA
...
einer halbj\"ahrlichen PrEP-Injektion mit $100\%$ Wirksamkeit und kÃ¶nnte die
AdhÃ¤renzproblematik der t\"aglichen PrEP fundamental l\"osen.

\subsection{Immuntherapie und monoklonale AntikÃ¶rper}
...
\item \textbf{Checkpoint-Inhibitoren}: HIV-spezifische CD8$^+$ T-Zellen werden w\"ahrend
      der chronischen Infektion exhausted (erschÃ¶pft) durch PD-1/PD-L1-Signalwege.
...
\subsection{MultimorbiditÃ¤t und Langzeitbetreuung}
...
\item \textbf{Osteoporose}: Erh\"ohte Frakturrate, bedingt durch HIV,
      Inflammation und TDF-induzierte renale tubulÃ¤re Dysfunktion.
\end{itemize}

Die integrierte Versorgung von HIV-Infizierten erfordert multidisziplinÃ¤re Teams
...
\item \textbf{Medikamenten-Pipeline f\"ur Niedriglohnl\"ander}: LA-ART (Lenacapavir)
      kostet in HocheinkommenslÃ¤ndern ca.\ 42.250 USD/Jahr. Generika-LA-ART
...
\item \textbf{Schl\"usselgruppen}: Homosexuelle M\"anner, transgender Personen,
      intravenÃ¶se Drogenkonsumenten und Sexarbeiter tragen weltweit
...
\item $<$ 250.000 AIDS-bedingte TodesfÃ¤lle j\"ahrlich,
