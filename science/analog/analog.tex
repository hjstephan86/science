...
Relativitätstheorie â€“ alle sind als Differenzialgleichungen über $\mathbb{R}^n$
...
seine fundamentalen Grenzen (Nyquistâ€“Shannon).
...
\begin{figure}[htbp]
    ...
    Die Kapazität wächst logarithmisch und ist unbegrenzt â€“ eine Eigenschaft
...
(â€žPower Wall'') bei ca.~100~W/cm ² \citep{Taur1998}.  Diese Grenzen sind fundamental,
...
durch eine Linse aus â€“ in $O(1)$ Zeit bezüglich der Signallänge.  Dies ist
...
Funktionen berechnen können.  Die präzise Charakterisierung dieser Klasse â€“
die sog.\ \emph{differenzialgebraischen Funktionen} â€“ gegenüber der Turing-Berechenbarkeit
...
Das Compressed-Sensing-Framework von CandÃ¨s und Tao \citep{Candes2006}
...
stochastische Differenzialgleichungen (ItÃ´-Kalkül) beschrieben:
\[
...
Signalverarbeitung â€“ verbunden mit Anwendungen in eingebetteten Systemen,
quantenmechanischen Modellen und neuronalen Differenzialgleichungen â€“
