...
Alle Ergebnisse werden durch zwÃ¶lf Matplotlib-Grafiken veranschaulicht
...
KundenwÃ¼nsche erf\"ullt und h\"ochste Anforderungen an Reichweite, Ladezeit
...
Tiefes Entladen maximiert die genutzte Energie, verkÃ¼rzt aber die Standzeit.
...
\begin{enumerate}
  ...
  \item \textbf{ZwÃ¶lf quantitative Auswertungen} mit Matplotlib-Grafiken
...
\begin{itemize}
  ...
  \item \textbf{Anode:} Graphit (mit Silizium-Beimischung fÃ¼r h\"ohere Kapazit\"at)
...
\begin{definition}[W\"armebilanzgleichung]
  ...
  (W/K) und KÃ¼hlleistung $\dot{Q}_{\mathrm{cool}}$ des Thermomanagementsystems.
\end{definition}
...
\begin{lemma}[Optimale RekuperationsverzÃ¶gerung]
\label{lem:rekup}
...
\begin{itemize}
  ...
  \item \textbf{Temperaturhomogenit\"at:} FlÃ¼ssigk\"uhlung sorgt fÃ¼r
...
\begin{figure}[H]
  ...
  \caption{CC-CV-Ladekurve: Spannung (rot, linke Achse), Strom (blau,
    rechte Achse) und SOC (gr\"un, rechte Achse) Ã¼ber die Ladezeit.
...
\begin{figure}[H]
  ...
  \caption{Oben: SOC-VerlÃ¤ufe der drei Ladestrategien (A: Schnell 0--100\,\%,
...
\begin{figure}[H]
  ...
  \caption{Batterietemperaturverl\"aufe w\"ahrend einer 60-min\"utigen
    ...
    im grÃ¼nen Bereich. Vorkonditionierung (gr\"un gestrichelt) erzielt
    das Optimum.}
  \label{fig:thermo}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Modellprognose (SOH vs. Laufleistung) vs. Porsche HV-Garantiekurve
    ...
    deutlich \"uber den Garantieschwellen. Selbst bei ungÃ¼nstiger Nutzung
...
\begin{enumerate}
  ...
  \item \textbf{Optimales SOC-Fenster:} Das theoretisch optimale Fenster
    ...
    formal begrÃ¼ndet (Satz~\ref{satz:soc}). Die Lebensdauerverl\"angerung
  ...
  \item \textbf{Reichweitenmaximierung:} Die optimale Reisegeschwindigkeit
    $v^*$ h\"angt von der verfÃ¼gbaren Reisezeit ab; das aerodynamische Limit
...
um den Faktor 5. HaupthÃ¼rde ist der \emph{Polysulfid-Shuttle-Effekt},
...
Bipolare Elektroden ermÃ¶glichen kompaktere Bauweise mit niedrigerem
...
Parafinbasierte PCM speichern LatentwÃ¤rme bei konstantem Temperaturniveau
...
\begin{itemize}
  ...
  \item \textbf{Flottenmanagementsysteme:} In Robotaxi-Flotten k\"onnen
    Fahrzeuge koordiniert laden und entladen, um die Netzlast zu glÃ¤tten
...
\begin{enumerate}
  ...
  \item Entwicklung eines \textbf{stochastischen Optimierungsrahmens}
    f\"ur V2G unter MarktpreisvolatilitÃ¤t
...
\bibitem{Porsche2024}
  Porsche AG:
  \emph{HV-Batterie-Garantiebedingungen fÃ¼r vollelektrische Fahrzeuge}.
