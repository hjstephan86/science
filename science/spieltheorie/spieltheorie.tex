...
EvolutionÃ¤re Spieltheorie und Shapley-Werte werden formal eingebettet.
...
\begin{itemize}
    ...
    \item Wirtschaftsnetzwerke als gekoppelte Spielgraphen modellieren,
          ...
          \"okonomische Modelle)
    \item EvolutionÃ¤re Dynamiken und koalitionale Spiele formal in den
...
Price~\cite{maynardsmith1973} begr\"undeten die evolutionÃ¤re Spieltheorie.
...
Best-Response-Struktur erhÃ¤lt:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{EvolutionÃ¤re Spieltheorie und Replikatordynamik}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{definition}[EvolutionÃ¤r Stabile Strategie]
Eine reine Strategie $p^* \in \Delta(S)$ ist \emph{evolutionÃ¤r stabil} (ESS),
...
\]
f\"ur alle Startwerte $p_0 \in (0,1)$ zum evolutionÃ¤r stabilen Gleichgewicht
\[
p^* = \frac{V}{C}.
\]
\end{satz}
...
NichtÃ¼bereinstimmung zeigt Design-Fehler auf.
