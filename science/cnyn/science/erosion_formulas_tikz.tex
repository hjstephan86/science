...
\node[formula] (f6) at (5.5, -4.7) {
    StrÃ¶mungsgeschw.: $v = \sqrt{\dfrac{2\Delta P}{\rho}} \approx 440 \, \mathrm{m/s}$
};
...
\node[formula] (f14) at (5.5, -13.9) {
    WÃ¤rmeentwicklung: $Q_{\mathrm{therm}} = E_{\mathrm{pot}} - E_{\mathrm{ero}} \approx 10^{22} \, \mathrm{J}$
};
...
\node[formula] (f17) at (-5.5, -20.1) {
    ErosionsverhÃ¤ltnis: $\dfrac{\tau}{\tau_c} \approx 1000 \text{ (intensive Erosion)}$
};
...
\node[formula] (f20) at (5.5, -20.1) {
    FlieÃŸtiefe: $h_{\mathrm{flow}} = \dfrac{Q}{W \cdot v} \approx 100 \, \mathrm{m}$
};
...
\node[formula] (f21) at (0, -23.3) {
    ...
    QuellenkapazitÃ¤t: $C_Q = \dfrac{Q_{\mathrm{max}}}{A_Q} \approx 10^3 \, \mathrm{m/s}$
};
