...
\begin{itemize}
	\item \textbf{Tag 1--40:} \textit{â€žUnd der Regen war vierzig Tage auf Erden"} (Genesis 7:12) -- Beginn der Flut
	
	\item \textbf{Tag 150:} \textit{â€žUnd das Gewässer nahm überhand und wuchs sehr auf Erden hundertundfünfzig Tage"} (Genesis 7:24) -- Maximum der Flut erreicht
	
	\item \textbf{Tag 150--221:} \textit{â€žDa ließ Gott einen Wind über die Erde gehen, und die Wasser fielen"} (Genesis 8:1-3) -- Beginn des Rücklaufs
	
	\item \textbf{Tag 314:} \textit{â€žAm ersten Tage des zehnten Monats sahen die Spitzen der Berge hervor"} (Genesis 8:5) -- Fortgeschrittener Rücklauf
	
	\item \textbf{Tag 371:} \textit{â€žIm sechshundertundersten Jahr am siebenundzwanzigsten Tage des zweiten Monats war die Erde ganz trocken"} (Genesis 8:14) -- Ende der Sintflut
\end{itemize}
...
Eine Textannotation im oberen Bereich des Plots hebt hervor: \textit{â€žAusgangszustand -- Wasser vollständig über dem Boden"}. Diese Phase entspricht dem biblischen Tag 150, an dem das Gewässer sein Maximum erreichte. Es findet noch keine Erosion statt; das System ist in einem metastabilen Gleichgewichtszustand. Die Legende in der oberen rechten Ecke identifiziert drei Komponenten: Gestein (braun), erodierter Bereich (heller Sand, \#D4A574) und Wasser (blau).
...
Das Verhältnis von Breite zu Tiefe der Erosionsrinne beträgt in dieser Phase etwa 1:0,008, was der im Hauptdokument hergeleiteten Geometrie entspricht. Die Textannotation \textit{â€žErosionstiefe: 225 m"} erscheint zentral im erodierten Bereich in einem halbtransparenten weißen Rahmen.
...
Der erodierte Bereich nimmt nun einen signifikanten Teil des Querschnitts ein. Die hellsandfarbe Zone erstreckt sich von etwa $-4,5$ km bis $+4,5$ km an der Oberfläche und verengt sich konisch zur maximalen Tiefe im Zentrum. Die Textannotation gibt die präzise Erosionstiefe an: \textit{â€žErosionstiefe: 675 m"}.

Das Raster (Grid) des Plots, in Grau mit 30\% Transparenz, ermöglicht eine präzise Ablesung der Dimensionen. Die Achsenbeschriftungen sind in 8-Punkt-Schrift gehalten: â€žBreite (km)" für die x-Achse und â€žTiefe (m)" für die y-Achse.
...
Die Textannotation \textit{â€žErosionstiefe: 1.125 m"} ist zentral im Canyon platziert. Der erodierte Bereich dominiert nun das Bild, während die verbleibende Wassermasse nur noch etwa 38\% des ursprünglichen Volumens ausmacht.
...
Die Textannotation \textit{â€žErosionstiefe: 1.575 m"} ist im mittleren Canyon-Bereich platziert. Das Canyon-Profil zeigt nun eine charakteristische Form, die der realen Geometrie des Grand Canyon bemerkenswert ähnlich ist.
...
Eine hervorgehobene Textannotation in der Canyon-Mitte verkündet in Fettschrift: \textit{â€žFinale Tiefe: 1.800 m"}. Der gelbe Hintergrund der Textbox (Farbe: gelb, Transparenz 80\%) hebt diese Information als Höhepunkt der Sequenz hervor.

Der Titel des Sub-Plots lautet: â€žZyklus 8 von 8 (Tag 40--220)", was andeutet, dass die finale Phase erheblich länger dauerte als die vorherigen Zyklen. Dies reflektiert die im Hauptdokument beschriebene Verlangsamung des Rücklaufprozesses gegen Ende, wenn der hydraulische Druck abnimmt.
...
Das 3D-Gitter ist in Grau mit 30\% Transparenz dargestellt und ermöglicht eine räum\-liche Orientierung. Die Achsenbeschriftungen sind in 7-Punkt-Schrift gehalten: â€žBreite (km)" für die x-Achse, â€žLänge (km)" für die y-Achse und â€žHöhe (m)" für die z-Achse.

Der Titel lautet: â€žZyklus 0 (Tag 0)", was den Ausgangszustand vor Beginn des Erosionsprozesses bezeichnet. Die Wasseroberfläche erscheint perfekt eben, ohne jegliche Stö\-rungen -- ein Zustand des hydraulischen Gleichgewichts.
...
Die 3D-Mesh-Struktur der Gesteinsoberfläche besteht aus 50Ã—50 Gitterpunkten, was eine hinreichend hohe Auflösung für die Darstellung der Topographie bietet. Die Farbcodierung (braun für Gestein, blau für Wasser) ermöglicht eine klare Unterscheidung der verschiedenen Komponenten.
...
Der Titel â€žZyklus 8 (Tag 40)" kennzeichnet diese Ansicht als finalen Zustand, wobei zu beachten ist, dass â€žTag 40" den Beginn der letzten Erosionsphase markiert, die sich bis Tag 220 erstreckt -- eine Phase gradueller Verfestigung und Stabilisierung.
...
Der erste Quadrant (oben links) trägt den Titel â€žHauptgleichungen" in 11-Punkt-Fettschrift und präsentiert die fundamentalen Beziehungen des Erosionsmodells.
...
Der zweite Quadrant (oben rechts) trägt den Titel â€žEnergiebilanz" und fokussiert auf die energetischen Aspekte des Erosionsprozesses. Der Hintergrund der Gleichungsboxen ist hellgelb (Farbe: lightyellow, Transparenz 30\%).
...
Der dritte Quadrant (unten links) trägt den Titel â€žErosionsmechanik" und beschreibt die physikalischen Prozesse der Gesteinserosion. Der Hintergrund der Gleichungsboxen ist hellgrün (Farbe: lightgreen, Transparenz 30\%).
...
Der vierte Quadrant (unten rechts) trägt den Titel â€žHydraulische Parameter" und quantifiziert die physikalischen Auswirkungen auf Objekte im Strömungsfeld. Der Hintergrund der Gleichungsboxen ist hellkoralle (Farbe: lightcoral, Transparenz 30\%).
...
Für einen Menschen mit Masse $m = 70$ kg resultiert eine Beschleunigung von etwa 71.000 m/s ², was etwa dem 7.200-fachen der Erdbeschleunigung entspricht. Ein zusätzlicher Kommentar in Klammern betont: â€ž(etwa 7.200Ã— Erdbeschleunigung!)".
...
Das erste Rechteck (y-Position von etwa 0,85 bis 0,73) repräsentiert die initiale Phase. Die Beschriftung in der linken Region (x = 0,08) lautet in Fettschrift: â€žPhase 1". Rechts daneben (x = 0,88, rechtsbündig) steht die Zeitangabe: â€žTag 0--30".

Die Prozessbeschreibung in der mittleren Region (x = 0,25, zentriert vertikal) erklärt in kursiver 8-Punkt-Schrift:
\begin{quote}
	\textit{â€žInitialer Wasserstand: Maximum\\
...
Das zweite Rechteck (y-Position von etwa 0,73 bis 0,61) markiert den Beginn des katastrophalen Rücklaufs. Die Beschriftung lautet: â€žPhase 2", Zeitangabe: â€žTag 30--60".

Die Prozessbeschreibung erklärt:
\begin{quote}
	\textit{â€ž1. Rücklaufzyklus beginnt\\
		Sog an Quellen baut sich auf: $\Delta P \approx 10^7$ Pa"}
\end{quote}

In dieser Phase öffnen sich die â€žQuellen der großen Tiefe" (oder beginnen aktiv Wasser zu absorbieren), was einen extremen Unterdruck von etwa $10^7$ Pa (100 bar) erzeugt. Dieser Unterdruck initiiert den Wasserrückzug und setzt die Strömung in Gang. Die Strömungsgeschwindigkeit beginnt zu steigen und erreicht bald die berechneten 440 m/s.

Das hellblaue Rechteck (Farbe \#D0E8F0) symbolisiert den noch hohen, aber beginnend sinkenden Wasserstand. Die Zeitangabe â€žTag 30--60" deutet an, dass diese Phase etwa 30 Tage dauert -- länger als die späteren Zyklen, da das System erst in Gang kommen muss.

\subsection{Phase 3: Massive Erosion}

Das dritte Rechteck (y-Position von etwa 0,61 bis 0,49) repräsentiert die erste aktive Erosionsphase. Beschriftung: â€žPhase 3", Zeitangabe: â€žTag 60--90".

Die Prozessbeschreibung lautet:
\begin{quote}
	\textit{â€žMassive Erosion: $v = 440$ m/s\\
...
Das vierte Rechteck (y-Position von etwa 0,49 bis 0,37) markiert eine Pausenphase zwischen Erosionszyklen. Beschriftung: â€žPhase 4", Zeitangabe: â€žTag 90--120".

Die Prozessbeschreibung erklärt:
\begin{quote}
	\textit{â€žDruckausgleich, Pause\\
...
Das Rechteck in Farbe \#A0D0E0 (mittleres Blau) symbolisiert den stabilen, mittleren Wasserstand. Die Zeitangabe â€žTag 90--120" deutet eine 30-Tage-Pause an, was etwa dem Sechsfachen der späteren Zyklusperiode von 5 Tagen entspricht -- ein Hinweis darauf, dass die frühen Phasen längere Ausgleichszeiten benötigten.

\subsection{Phase 5: Zweiter Rücklaufzyklus}

Das fünfte Rechteck (y-Position von etwa 0,37 bis 0,25) beschreibt den zweiten aktiven Erosionszyklus. Beschriftung: â€žPhase 5", Zeitangabe: â€žTag 120--150".

Die Prozessbeschreibung lautet:
\begin{quote}
	\textit{â€ž2. Rücklaufzyklus\\
...
Das Rechteck in Farbe \#88C4D8 (mittleres Dunkelblau) symbolisiert den weiter gesunkenen Wasserstand. Die Zeitangabe â€žTag 120--150" deutet eine 30-Tage-Phase an, konsistent mit den früheren Zyklen.

\subsection{Phase 6: Wiederholende Zyklen}

Das sechste Rechteck (y-Position von etwa 0,25 bis 0,13) fasst die mittleren bis späten Erosionszyklen zusammen. Beschriftung: â€žPhase 6", Zeitangabe: â€žTag 150--350".

Die Prozessbeschreibung erklärt:
\begin{quote}
	\textit{â€žWiederholende Zyklen\\
...
Das Rechteck in Farbe \#70B8D0 (dunkles Blau) symbolisiert den niedrigen Wasserstand. Die Zeitangabe â€žTag 150--350" deutet eine lange Phase von 200 Tagen an -- etwa 40 Zyklen Ã  5 Tage, konsistent mit der im Hauptdokument abgeleiteten Gesamtzahl von 40--50 Zyklen.

\subsection{Phase 7: Finaler Zustand}

Das siebte und letzte Rechteck (y-Position von etwa 0,13 bis 0,01) beschreibt den abschließenden Zustand. Beschriftung: â€žPhase 7", Zeitangabe: â€žTag 350--370".

Die Prozessbeschreibung lautet:
\begin{quote}
	\textit{â€žFinaler Zustand nach $\sim$220 Tagen\\
...
Das Rechteck in Farbe \#58ACC8 (sehr dunkles Blau, fast Cyan) symbolisiert den minimalen Wasserstand oder vollständigen Wasserabfluss. Die Zeitangabe â€žTag 350--370" entspricht den letzten 20 Tagen der Sintflut-Chronologie, während derer die Erde â€žganz trocken" wurde (Genesis 8:14).
...
\begin{quote}
	\textbf{â€žKernmechanismus: Vernetztes Quellensystem mit begrenzter Kapazität\\
		â†’ Rhythmischer Wasserrückzug in Zyklen von $\sim$5 Tagen\\
		â†’ Jede Pause erzeugt eine horizontale Schicht\\
		â†’ 40--50 Zyklen = 40--50 charakteristische Rillen"}
\end{quote}
...
Die vier Stichpunkte (markiert mit â†’-Pfeilen) erklären die kausale Kette:
\begin{enumerate}
...
Diese Box ist visuell hervorgehoben durch den goldenen Hintergrund und die zentrale Position am Ende des Diagramms. Sie dient als abschließende Zusammenfassung und â€žTake-Home-Message" der gesamten Visualisierung.
...
\begin{figure}[htbp]
    ...
    \caption{Links: Relativer Vergleich der Quantenwirksamkeit zwischen Erde (blau, makroskopisch) und Nichts des Schwarzen Lochs (rot, Planck-Skala). Auf der Erde sind z.B. Quantenfluktuationen auf etwa 8\,\% des theoretischen Maximums begrenzt, Vakuumenergie auf 5\,\%. Im Nichts sind alle sechs Kriterien auf 100\,\% skaliert â€“ die Quantenphysik herrscht uneingeschränkt. Rechts: Korrespondenzprinzip quantitativ â€“ der Quantenanteil fällt von 100\,\% (für $S = \hbar$, Singularität) auf nahezu 0\,\% (für $S \gg \hbar$, Erde). Der Übergang liegt bei $S/\hbar \approx 1$--$10^2$.}
...
\begin{figure}[htbp]
    ...
    \caption{Thermodynamische und quantenphysikalische Analyse der Lebensfeindlichkeit. Oben links: Unruh-Temperatur in Abhängigkeit des Abstands vom Ereignishorizont â€“ am Horizont selbst dominiert die Hawking-Temperatur (orange gestrichelt), zur Singularität hin divergiert sie auf zur Planck-Temperatur $T_P \approx 10^{32}$ K. Oben rechts: Vakuumenergiediichte $\rho \propto \hbar c / r^4$ -- die Planck-Energiedichte (rot gestrichelt) übersteigt atomare Bindungsenergien um über 100 Größenordnungen. Unten links: Gravitationszeitdilatation am Ereignishorizont -- die Eigenzeit friert ein (biologische Prozesse stehen still). Unten rechts: Lebbarkeitsindex nach sieben Kriterien: Auf der Erde nahe 100\,\% für alle Kriterien; im Nichts des Schwarzen Lochs absolut 0\,\% für alle sieben Kriterien â€“ Leben ist nach jeder Maßgabe unmöglich.}
...
Die extreme Tödlichkeit der Quellen während der Rücklaufphase -- mit Sogkräften von 5.000 kN und Beschleunigungen von 7.280Ã—g -- unterstreicht die absolute Souveränität Gottes über die Naturkräfte. Die biblische Erzählung berichtet korrekterweise von keinen Versuchen, durch Tauchen oder andere physische Mittel zu entkommen, was angesichts dieser extremen Bedingungen auch unmöglich gewesen wäre.
...
Dieses Kapitel belegt in diesem Sinne das im Titel formulierte Prinzip: \textit{â€žAuf dieser Erde wirkt die Quantenphysik zwar auch schon, aber noch nicht so wie in dem Bereich des Nichts der schwarzen Löcher"} -- und quantifiziert dieses "`nicht so"' mit expliziten Zahlenwerten.
...
\begin{center}
	...
	\textit{â€žUnd Gott gedachte an Noah und an alle Tiere und an alles Vieh, das mit ihm in der Arche war, und ließ Wind auf Erden kommen, und das Wasser fiel."}
