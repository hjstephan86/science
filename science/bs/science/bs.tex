...
\begin{document}
	...
	auf dem \textbf{EDF$^+$}-Scheduling-Algorithmus \cite{Epp2025edfplus} als zentralem
	...
	EDF$^+$-Scheduling \cite{Epp2025edfplus} als einheitliches Paradigma über alle
	...
	EDF$^+$ (Earliest Deadline First Plus) \cite{Epp2025edfplus} erweitert den
...
class Driver:
	...
	\texttt{gitlab.com/epp-group/} veröffentlicht. Die nächste Stufe
	...
	\begin{thebibliography}{99}
		...
		\texttt{gitlab.com/epp-group/vadis}
