...
bereits vorhandene Dokumente verschoben werden müssen â€“ im schlimmsten Fall
...
Wartezeit zurückgesetzt â€“ das System sammelt Dokumente, bis eine
...
\begin{enumerate}[label=\arabic*.,noitemsep]
  ...
  \item \textbf{Ereignis â€“ Dokumentankunft:} Bei Ankunft von Dokument $d$
        ...
        $T \sim F$ neu.
  \item \textbf{Ereignis â€“ Timerablauf:} Falls kein Dokument während~$T$
...
Archiv $\mathcal{A}$   & Cache-Inhalt / TLB-Einträge        & L1â€“L3, TLB\\
...
mittlere Batchgröße von $\E[|B|] = \lambda/\mu = 0.4$ â€“ also typischerweise
...
$H > 0.5$) â€“ typisch für Web-Traffic und Datei-I/O â€“ gilt:
...
selbstähnliche Workloads mit typischen Hurst-Exponenten $H \in [0.75, 0.9]$ sind â€“
