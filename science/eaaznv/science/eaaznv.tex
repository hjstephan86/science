...
von \textbf{20\,cm Ã— 20\,cm} (25 Messpunkte/m ²) werden in einem einmaligen Aufnahmeprozess
...
verursacht werden \cite{iho2020, imocircular}. Die Dynamik von Küstengewässern â€“
hervorgerufen durch Sedimenttransport, Gezeitenströmungen und anthropogene Eingriffe â€“
...
Diese zeitliche Lücke zwischen Messung und Verfügbarkeit kann kritisch sein â€“ insbesondere
...
\begin{enumerate}[label=\alph*)]
  \item eine einmalige, flächendeckende Geländeaufnahme durch Drohnen oder Satelliten
        mit einem Messraster von 20\,cm Ã— 20\,cm (25 Messpunkte/m ²),
...
\midrule
Lotleine / Echolot & 0{,}5â€“2\,m & Periodisch & Punktweise; Schiff nötig \\
Fächerecholot (MBES) & 0{,}1â€“0{,}5\,m & Periodisch & Hohe Kosten; komplexe Logistik \\
Airborne LiDAR & 0{,}25â€“1\,m & Periodisch & Wetterabhängig; teuer \\
Satellitenaltimetrie & 5â€“50\,m & Täglich & Zu grob für Flachwasser \\
\bottomrule
\end{tabular}
\end{table}
...
%-------------------------------------------------------------
\subsection{Räumliches Abtasttheorem (2-D Nyquistâ€“Shannon)}
%-------------------------------------------------------------
...
Die navigationsrelevante Mindestgröße eines Bodenhindernisses â€“ definiert als
diejenige Strukturbreite $w_{\min}$, unterhalb derer ein Objekt für die
Flachwassernavigation keine Gefährdung mehr darstellt â€“ liegt nach
...
also weniger als $2\,\%$ zusätzliche Signalleistung â€“ bei gleichzeitig
...
\begin{itemize}
  \item Rasterweiten $d < 20\,\text{cm}$ erhöhen die Datenmenge um den Faktor
        ...
        â€“ ohne für die beschriebene Navigationsanwendung
