...
\title{HochauflÃ¶sende Tiefenvermessung}
\author{Stephan Epp}
\date{4. MÃ¤rz 2026}
...
\section{Einleitung}
%=============================================================
Die vorliegende Arbeit stellt ein neuartiges System zur hochauflÃ¶senden Tiefenvermessung
in KÃ¼stengewÃ¤ssern und StrandnÃ¤he vor. Die bathymetrischen Daten mit einem Messraster
von \textbf{20\,cm Ã— 20\,cm} (25 Messpunkte/mÂ²) werden in einem einmaligen Aufnahmeprozess
durch Drohnen oder Satelliten erhoben, in einer rÃ¤umlichen Datenbank als \textbf{ideales Raster}
gespeichert und anschlieÃŸend Ã¼ber eine standardisierte REST-API in Echtzeit fÃ¼r die Navigation
bereitgestellt. KapitÃ¤ne, HafenbehÃ¶rden sowie autonome Navigationssysteme erhalten so eine
prÃ¤zise, rasterbasierte Grundlage fÃ¼r die sichere Planung von Wasserfahrzeugrouten.

Die Navigation in KÃ¼stengewÃ¤ssern, FlussmÃ¼ndungen und Hafenanlagen zÃ¤hlt zu den
anspruchsvollsten Aufgaben der Seefahrt. Trotz moderner elektronischer Seekarten und
GPS-basierter Positionierung kommt es weltweit regelmÃ¤ÃŸig zu GrundberÃ¼hrungen und
Havarien, die durch unzureichendes oder veraltetes Wissen Ã¼ber aktuelle Wassertiefen
verursacht werden \cite{iho2020, imocircular}. Die Dynamik von KÃ¼stengewÃ¤ssern â€“
hervorgerufen durch Sedimenttransport, GezeitenstrÃ¶mungen und anthropogene Eingriffe â€“
fÃ¼hrt dazu, dass selbst kÃ¼rzlich erstellte Seekarten innerhalb weniger Wochen an Genauigkeit
verlieren kÃ¶nnen.

\medskip\noindent
Bestehende Systeme zur Tiefenvermessung basieren hÃ¤ufig auf periodischen Messfahrten
mit Vermessungsschiffen, welche die Daten nachtrÃ¤glich aufbereiten und verÃ¶ffentlichen.
Diese zeitliche LÃ¼cke zwischen Messung und VerfÃ¼gbarkeit kann kritisch sein â€“ insbesondere
in Bereichen mit hohem Sedimentaufkommen oder nach Sturmereignissen
\cite{minkoff2019, guenther2000}.

\medskip\noindent
Das in dieser Arbeit vorgestellte System schlieÃŸt diese LÃ¼cke durch:

\begin{enumerate}[label=\alph*)]
  \item eine einmalige, flÃ¤chendeckende GelÃ¤ndeaufnahme durch Drohnen oder Satelliten
        mit einem Messraster von 20\,cm Ã— 20\,cm (25 Messpunkte/mÂ²),
  \item eine strukturierte Speicherung der prozessierten Messdaten als ideales Raster
        in einer rÃ¤umlichen Datenbank und
  \item eine Echtzeit-Bereitstellung der Navigationsdaten auf Grundlage dieses idealen
        Rasters Ã¼ber eine Ã¶ffentlich zugÃ¤ngliche REST-API.
\end{enumerate}

\subsection{Motivation und Relevanz}

Gerade in touristisch genutzten KÃ¼stenbereichen, Wattenmeeren und flachen HÃ¤fen stellt
die aktuelle Kenntnis der GewÃ¤ssertiefe eine Voraussetzung fÃ¼r die Sicherheit von Personen
und Material dar. Ausflugsdampfer, Segelboote, Kayaks sowie zunehmend autonome
Wasserfahrzeuge benÃ¶tigen verlÃ¤ssliche Tiefenprofile als Grundlage ihrer
Routenplanung. Das vorgeschlagene System adressiert diesen Bedarf auf skalierbare und
kosteneffiziente Weise.

\subsection{Zielsetzung der Arbeit}

Ziel dieser Arbeit ist es, die Gesamtarchitektur des Systems â€“ bestehend aus einmaliger
Aufnahmephase per Drohne oder Satellit, rÃ¤umlicher Datenbankinfrastruktur und
Echtzeit-API â€“ zu beschreiben, die Leistungsparameter zu quantifizieren und anhand eines
prototypischen Einsatzszenarios die praktische Anwendbarkeit fÃ¼r die Navigation auf
...
Traditionelle Methoden der Tiefenvermessung in KÃ¼stengewÃ¤ssern lassen sich in drei
...
\toprule
\textbf{Verfahren} & \textbf{AuflÃ¶sung} & \textbf{AktualitÃ¤t} & \textbf{EinschrÃ¤nkungen} \\
\midrule
Lotleine / Echolot & 0{,}5â€“2\,m & Periodisch & Punktweise; Schiff nÃ¶tig \\
FÃ¤cherecholot (MBES) & 0{,}1â€“0{,}5\,m & Periodisch & Hohe Kosten; komplexe Logistik \\
Airborne LiDAR & 0{,}25â€“1\,m & Periodisch & WetterabhÃ¤ngig; teuer \\
Satellitenaltimetrie & 5â€“50\,m & TÃ¤glich & Zu grob fÃ¼r Flachwasser \\
\bottomrule
\end{tabular}
\end{table}
...
Echtzeit-Daten und erfordern fÃ¼r eine flÃ¤chendeckende Abdeckung erhebliche logistische
und finanzielle Ressourcen \cite{guenther2000, parente2020}.

\subsection{Neuere AnsÃ¤tze und ForschungslÃ¼cken}
...
Das System basiert auf einer einmaligen GelÃ¤ndeaufnahme durch Drohnen oder Satelliten.
Die erhobenen Rohdaten werden in ein einheitliches, quadratisches Messraster mit einem
Abstand von \textbf{20\,cm} zwischen benachbarten Gitterpunkten in LÃ¤ngs- und Querrichtung
Ã¼berfÃ¼hrt \textendash{} das \textbf{ideale Raster}. Dies entspricht
...
\medskip\noindent
Die FlÃ¤chenabdeckung erstreckt sich Ã¼ber die gesamte nutzbare Strandbreite $B$, Ã¼blicherwei\-se
im Bereich von 50 bis 500\,m, sowie Ã¼ber eine Tiefenzone $L$, die von der Uferlinie bis zur
Tiefengrenze sicherer Einfahrt reicht (typischerweise 100â€“500\,m seeseitig). Die Gesamtzahl
...
\noindent
FÃ¼r ein Beispielareal mit $B = 200\,\text{m}$ und $L = 150\,\text{m}$ resultiert dies in:
...
Die Tiefendaten werden durch eine einmalige Beflie\-gung oder Satelliten\-Ã¼berfahrt
erfasst. Je nach Anwendungsgebiet kommen folgende Messprinzipien zum Einsatz:

\begin{itemize}
  \item \textbf{Drohnen-gestÃ¼tzte bathymetrische LiDAR-Aufnahme:} Ein GrÃ¼nlicht-Laser
        (532\,nm) durchdringt die WasserssÃ¤ule und reflektiert am GewÃ¤sserboden; die
        Laufzeitdifferenz ergibt die Wassertiefe mit einer Genauigkeit von $\pm 0{,}5\,\text{cm}$.
  \item \textbf{Drohnen-gestÃ¼tztes FÃ¤cherecholot (MBES):} Ein an der Drohne befestigtes
        Multibeam-Sonar erfasst bei niedrigen FlughÃ¶hen (3\textendash10\,m Ã¼ber dem Wasserspiegel)
        breite Tiefenstreifen mit hoher Punktdichte.
  \item \textbf{Satellitenbasierte Bathymetrie (SDB):} Multispektrale Satellitenbilder
        (z.\,B.\ Sentinel-2, WorldView) ermÃ¶glichen mittels Wassertiefenmodellen eine
        flÃ¤chendeckende Aufnahme gro\ss{}er KÃ¼stengebiete bei geeigneten SichtverhÃ¤ltnissen.
\end{itemize}

\noindent
Die Rohdaten aller Aufnahmemethoden werden nach der Erfassung prozessiert und in das
ideale 20\,cm-Raster Ã¼berfÃ¼hrt, das persistent in der rÃ¤umlichen Datenbank gespeichert wird.
...
%=============================================================
\section{Mathematisch-analytische BegrÃ¼ndung der Rasterwahl}
%=============================================================

Dieser Abschnitt legt formal dar, warum ein quadratisches Raster mit der Gitterweite
$d = 20\,\text{cm}$ fÃ¼r die beschriebene Navigationsanwendung mathematisch optimal ist.
Dabei werden das rÃ¤umliche Abtasttheorem, Navigationssicherheitsanforderungen,
Informationstheoretische Grenzen sowie ein quantitativer Datenratenvergleich gegenÃ¼ber
alternativen Rasterweiten herangezogen.

%-------------------------------------------------------------
\subsection{RÃ¤umliches Abtasttheorem (2-D Nyquistâ€“Shannon)}
%-------------------------------------------------------------
...
\begin{equation}
  ...
  \label{eq:nyquist1d}
\end{equation}
betragen. Auf zweidimensionale rÃ¤umliche Signale erweitert sich dieses Kriterium
direkt: FÃ¼r ein isotropes Bodenrelief mit der maximalen rÃ¤umlichen Frequenz
...
\begin{equation}
  ...
  \label{eq:nyquist2d}
\end{equation}
erfÃ¼llen \cite{oppenheim1996, marks2009}. Aliasing-Artefakte entstehen
genau dann, wenn \eqref{eq:nyquist2d} verletzt wird: Strukturen kleiner als
$2d$ werden im Raster entweder gar nicht oder mit falscher rÃ¤umlicher
Zuordnung abgebildet.

\medskip\noindent
\textbf{Anwendung auf KÃ¼stenbathymetrie.}
Die navigationsrelevante MindestgrÃ¶ÃŸe eines Bodenhindernisses â€“ definiert als
diejenige Strukturbreite $w_{\min}$, unterhalb derer ein Objekt fÃ¼r die
Flachwassernavigation keine GefÃ¤hrdung mehr darstellt â€“ liegt nach
...
\begin{equation}
  ...
  \label{eq:dmax}
\end{equation}
\textbf{Ein Raster mit $d = 20\,\text{cm}$ ist damit genau die grÃ¶bste
Gitterweite, die sÃ¤mtliche navigationsrelevanten Bodenstrukturen
aliasingfrei abbildet.} Jede feinere AuflÃ¶sung ($d < 20\,\text{cm}$)
erhÃ¶ht die Datenmenge quadratisch, ohne zusÃ¤tzliche
sicherheitsrele\-vante Information zu liefern; jede grÃ¶bere
AuflÃ¶sung ($d > 20\,\text{cm}$) verletzt das Nyquist-Kriterium und
birgt Aliasing-Risiken.

%-------------------------------------------------------------
\subsection{Navigatorische MindestauflÃ¶sung und Tiefgangsanalyse}
%-------------------------------------------------------------

Der Sicherheitsabstand $\delta$ zwischen dem Kiel eines Fahrzeugs mit
Tiefgang $T$ und der GewÃ¤ssersohle ist definiert als:
\begin{equation}
...
\end{equation}
wobei $\Delta z_{\max}$ der maximale HÃ¶henunterschied zwischen
benachbarten Gitterpunkten ist. FÃ¼r typische KÃ¼stenbodentopographien
mit $\Delta z_{\max} \approx 20\,\text{cm}$ und $d = 20\,\text{cm}$
betrÃ¤gt dieser Fehler lediglich $\varepsilon_h \approx 5\,\text{cm}$
â€“ deutlich unterhalb des geforderten $\delta_{\min}$.

\medskip\noindent
Bei Gitterweiten $d \geq 50\,\text{cm}$ hingegen kÃ¶nnen Hindernisse der
GrÃ¶ÃŸe $20\,\text{cm} \leq w < 50\,\text{cm}$ vollstÃ¤ndig im Raster
verschwindet; der Interpolationsfehler Ã¼bersteigt dann regelmÃ¤ÃŸig den
...
Die rÃ¤umliche Entropie $H$ eines Tiefenfeldes der FlÃ¤che $A$ bei
...
$A/d^2$ die Anzahl der Gitterpunkte darstellt, wÃ¤chst die
absolute Informationsmenge mit abnehmendem $d$ quadratisch an.
Die \emph{navigationsrelevante} Entropie sÃ¤ttigt jedoch bei
$d = d^* = 1/(2\,\nu_{\max})$: Unterhalb von $d^*$ werden keine
zusÃ¤tzlichen entscheidungsrelevanten Informationen (im Sinne von
durch \eqref{eq:kielfreiheit} auflÃ¶sbaren Tiefenunterschieden)
gewonnen, da das bathymetrische Signal oberhalb $\nu_{\max}$
praktisch kein Leistungsspektrum mehr aufweist \cite{goff1988}.

\medskip\noindent
Formal lÃ¤sst sich dies durch das Leistungsdichtespektrum
$S(\nu_x, \nu_y)$ des Bodenreliefs ausdrÃ¼cken. FÃ¼r typische
KÃ¼stensedimentbÃ¶den folgt das Spektrum nÃ¤herungsweise einem
...
also weniger als $2\,\%$ zusÃ¤tzliche Signalleistung â€“ bei gleichzeitig
...
Die Gesamtzahl der Gitterpunkte Ã¼ber einer FlÃ¤che $A = B \cdot L$ ist:
\begin{equation}
...
\begin{equation}
  ...
  \label{eq:skalierung}
\end{equation}
Die Rohdatenmenge $M(d)$ pro vollstÃ¤ndigem Gebiets-Snapshot bei
$s = 64\,\text{Byte}$ pro Gitterpunkt skaliert dementsprechend:
\begin{equation}
  M(d) = N(d)\cdot s = \frac{A \cdot s}{d^2}
  \label{eq:datenmenge}
\end{equation}
FÃ¼r die BeispielflÃ¤che $A = 200\,\text{m} \times 150\,\text{m} = 30.000\,\text{m}^2$:
\begin{table}[H]
\centering
\caption{Datenmengen- und Datenratenvergleich fÃ¼r verschiedene Rasterweiten
         (BeispielflÃ¤che $200\,\text{m}\times150\,\text{m}$,
          $s = 64\,\text{Byte/Punkt}$, Abfragerate $f_q = 1\,\text{Hz}$)}
\label{tab:rastervergleich}
\renewcommand{\arraystretch}{1.45}
\begin{tabular}{@{}r r r r r r r@{}}
\toprule
\textbf{Raster} & \textbf{Punkte/mÂ²} & \textbf{Punkte}
...
vollstÃ¤ndige FlÃ¤chenabfrage aller Gitterpunkte mit $f_q = 1\,\text{Hz}$.
In der praktischen Implementierung werden Bounding-Box-Abfragen eingesetzt,
die nur den jeweils relevanten Kartenausschnitt Ã¼bertragen; dies reduziert
den tatsÃ¤chlichen Ãœbertragungsbedarf typischerweise um den Faktor
$10$â€“$100$.

\medskip\noindent
\textbf{Schlussfolgerung aus dem Vergleich.}
\begin{itemize}
  \item Rasterweiten $d < 20\,\text{cm}$ erhÃ¶hen die Datenmenge um den Faktor
        $(20/d)^2$ â€“ bei $d = 5\,\text{cm}$ um Faktor $16$
        â€“ ohne fÃ¼r die beschriebene Navigationsanwendung
        irelevante neue Information zu liefern.
  \item Rasterweiten $d > 20\,\text{cm}$ verletzen das Nyquist-Kriterium
        \eqref{eq:dmax} und kÃ¶nnen sicherheitskritische Hindernisse
        auflÃ¶sungsbedingt verschlucken.
  \item Die Gitterweite $d = 20\,\text{cm}$ stellt damit den exakten
        Schnittpunkt von Nyquist-konformer Abtastung und minimaler
        Datenrate dar â€“ eine \emph{mathematisch notwendige und
        hinreichende} Wahl.
\end{itemize}
...
Die Wahl der Gitterweite lÃ¤sst sich als eingeschrÃ¤nktes
Optimierungsproblem formulieren. Sei $\mathcal{D}(d)$ die Datenrate
als Kostenfunktion und $\mathcal{I}(d)$ ein MaÃŸ fÃ¼r den
...
\begin{equation}
  ...
  \label{eq:opt_neb}
\end{equation}
Da $M(d)$ streng monoton fallend in $d$ ist, ist die LÃ¶sung:
\begin{equation}
  \boxed{d^* = d_{\rm Nyq} = 20\,\text{cm}}
  \label{eq:opt_loesung}
\end{equation}
Die Kostenfunktion $M(d)$ verhÃ¤lt sich fÃ¼r $d < d^*$ wie:
\begin{equation}
  M(d) = M(d^*) \cdot \left(\frac{d^*}{d}\right)^2
  \label{eq:kostenquadrat}
\end{equation}
Beispiel: Eine Halbierung der Gitterweite von $20\,\text{cm}$ auf
$10\,\text{cm}$ vervierfacht Datenmenge und Ã¼bertragene Datenrate,
reduziert die Ã¼bermittelte navigationsrelevante Information
(gemessen in Einheiten \eqref{eq:spectralpower}) jedoch um weniger
als $2\,\%$. Dieses \textbf{quadratisch-lineare MissverhÃ¤ltnis}
beweist formal die Ãœberlegenheit von $d^* = 20\,\text{cm}$
gegenÃ¼ber jeder feineren Rasterung.
...
hexagonale und dreieckige Gitter gelÃ¤ufig \cite{sahr2003}.

\begin{table}[h]
\centering
\caption{Vergleich gebrÃ¤uchlicher Rastergeometrien hinsichtlich
...
Hexagonal ($r$) & $\approx 1{,}07\times$ & hoch & eingeschrÃ¤nkt
  & 7\,\% effizientere FlÃ¤chendeckung \cite{conway2013},
    aber komplexe DB-Strukturen \\
Dreieckig & $\approx 0{,}87\times$ & sehr gering & schlecht
  & UngÃ¼nstige Richtungsasymmetrie \\
IrregulÃ¤r (TIN) & variabel & -- & schlecht
  & Optimal fÃ¼r Originalmessdaten, ungeeignet fÃ¼r Raster-API \\
\bottomrule
\end{tabular}
\end{table}
...
bessere FlÃ¤chendeckungseffizienz (hÃ¶herer Nyquist-Rate relativ
zur Punktdichte) \cite{conway2013}. Jedoch Ã¼berwiegen fÃ¼r die
...
auf geografische Koordinatensysteme (EPSG:4326) erfordern aufwÃ¤ndige
...
Die Daten werden Ã¼ber eine RESTful-API im GeoJSON-Format bereitgestellt. Die API
folgt dem OpenAPI-3.0-Standard und ermÃ¶glicht sowohl punkt- als auch fÃ¤chenbasierte
...
bis zur vollstÃ¤ndigen Ãœbertragung der Navigationsdaten. Da die Rohdatenverarbeitung
vollstÃ¤ndig im Vorfeld abgeschlossen wird, beschrÃ¤nkt sich die Laufzeit auf den
Datenbankzugriff und die NetzwerkÃ¼bertragung. Die Datenmenge einer typischen
Bereichsabfrage (Bounding-Box 500\,m $\times$ 200\,m) betrÃ¤gt:
...
Durch rÃ¤umliche Datenbankindizes (z.\,B.\ GiST-Index in PostGIS) und server\-seitiges
GeoJSON-Chunking wird der effektive Ãœbertragungsstrom auf typisch 1\textendash5\,MB/s begrenzt.

%=============================================================
\section{QualitÃ¤tssicherung und Kalibrierung}
%=============================================================

\subsection{Datenverarbeitungs-Pipeline und QualitÃ¤tssicherung}

Die ÃœberfÃ¼hrung der Rohdaten in das ideale Raster erfolgt in einer definierten
...
\begin{enumerate}
  \item \textbf{Georeferenzierung:} Alle Messpunkte werden auf Basis der Positions-
        ...
        geodÃ¤tische Referenzsystem (ETRS89\/WGS84) transformiert.
  \item \textbf{Kalibrierung und Schallgeschwindigkeitskorrektur:} FÃ¼r Echolot- und
  ...
  \item \textbf{Rasterisierung auf ideales Gitter:} Die unregelmÃ¤ÃŸig verteilten
        Rohdatenpunkte werden mittels Kriging- oder TIN-Interpolation auf das
        regulÃ¤re 20\,cm $\times$ 20\,cm Raster Ã¼berfÃ¼hrt und in der Datenbank gespeichert.
\end{enumerate}

\subsection{Fehlerbehandlung und DatengÃ¼te}

Jeder Messwert wird mit einem QualitÃ¤tsindikator (QI) nach \cite{iho2020} klassifiziert:

\begin{table}[H]
\centering
\caption{QualitÃ¤tsindikatoren der Messwerte}
\label{tab:qualitaet}
\renewcommand{\arraystretch}{1.3}
\begin{tabular}{@{}cll@{}}
\toprule
...
B & Gut & Abweichung 1â€“5\,cm \\
C & Akzeptabel & Abweichung 5â€“15\,cm \\
D & Zweifelhaft & Abweichung $>$ 15\,cm \\
X & UngÃ¼ltig & Sensorfehler \\
\bottomrule
\end{tabular}
\end{table}
...
Das primÃ¤re Anwendungsgebiet ist die UnterstÃ¼tzung von Schiffs- und BootsfÃ¼hrern beim
Einlaufen in flache HÃ¤fen, beim Passieren von SandbÃ¤nken und beim AnkermanÃ¶ver in
Wattengebieten. Navigations-Apps integrieren die API-Daten und stellen dem KapitÃ¤n
ein aktuelles Tiefenprofil der geplanten Route dar. Das System ermÃ¶glicht darÃ¼ber hinaus:
...
\begin{itemize}
  ...
  \item UnterstÃ¼tzung autonomer Wasserfahrzeuge (USV) bei der Kollisionsvermeidung.
\end{itemize}

\subsection{KÃ¼stenmanagement und Umweltmonitoring}

Ãœber die Navigation hinaus liefern die hochfrequenten Tiefenprofile wertvolle Daten fÃ¼r
die Geomorphologie von KÃ¼stenabschnitten, die FrÃ¼herkennung von Sandwanderungen
sowie die Planung von BaggermaÃŸnahmen.

\subsection{Such- und RettungseinsÃ¤tze}

Bei SeenotfÃ¤llen ermÃ¶glicht das System RettungskrÃ¤ften, geeignete Anfahrtswege fÃ¼r
Schlauchboote oder Hubschrauber Ã¼ber seichten GewÃ¤ssern in Echtzeit zu identifizieren.

%=============================================================
\section{Prototypische Implementierung und Ergebnisse}
%=============================================================

Ein Pilotprojekt wurde an einem 200\,m breiten KÃ¼stenabschnitt mit einer LÃ¤nge von
150\,m Ã¼ber einen Zeitraum von 12 Wochen durchgefÃ¼hrt. Die wichtigsten Ergebnisse
...
\noindent
Die Ergebnisse belegen, dass alle definierten Zielwerte erreicht oder Ã¼bertroffen wurden.
Insbesondere die Tiefengenauigkeit von $\pm 0{,}7\,\text{cm}$ Ã¼bertrifft selbst die
...
\subsection{StÃ¤rken des Systems}

Das vorgestellte System verbindet drei wesentliche Vorteile: hohe rÃ¤umliche AuflÃ¶sung
durch das ideale 20\,cm-Raster, flexible und skalierbare Datenerfassung per Drohne oder
Satellit ohne permanente Sensorinfrastruktur sowie eine sofortige Echtzeit-VerfÃ¼gbarkeit
der Navigationsdaten Ã¼ber die REST-API. GegenÃ¼ber klassischen Befahrungsverfahren
entfÃ¤llt der Aufwand fÃ¼r eine fest installierte Sensor\-infrastruktur; die Datenbankarchitektur
ermÃ¶glicht eine beliebig hÃ¤ufige Wiederaufnahme und einen unmittelbaren Austausch
veralteter DatenbestÃ¤nde.

\subsection{Limitierungen und Herausforderungen}

Da die Messdaten einmalig aufgenommen werden, spiegeln sie den Zustand des GewÃ¤ssers
zum Aufnahmezeitpunkt wider. In Bereichen mit hohem Sedimenttransport oder nach
Sturmereignissen kÃ¶nnen signifikante TiefenverÃ¤nderungen eintreten, die eine erneute
Aufnahme und Datenbankaktualisierung erfordern. Die API liefert in diesem Fall nicht
die aktuelle MessrealitÃ¤t, sondern den zuletzt gespeicherten Datensatz des idealen
Rasters; eine klar kommunizierte Altersangabe (\texttt{survey\_date}) ist daher
zwingend erforderlich. Satellitenbasierte Verfahren sind zusÃ¤tzlich auf ausreichende
Wasserklarheit und gÃ¼nstige LichtverhÃ¤ltnisse angewiesen.

\subsection{Ausblick}

Weiterentwicklungen umfassen die Integration von maschinellen Lernverfahren zur
prÃ¤dikti\-ven Modellierung von TiefenverÃ¤nderungen sowie die Erweiterung der API um
...
Die vorgestellte LÃ¶sung zur hochauflÃ¶senden Tiefenvermessung adressiert eine bedeutende
LÃ¼cke in der maritimen Sicherheitsinfrastruktur. Durch die einmalige GelÃ¤ndeaufnahme
mittels Drohnen oder Satelliten, die Speicherung der prozessierten Daten als ideales
20\,cm-Raster in einer rÃ¤umlichen Datenbank und die Bereitstellung Ã¼ber eine REST-API
mit einer Latenz unter 500\,ms entsteht eine flexible, skalierbare und kosteneffiziente
LÃ¶sung. Die API stellt die Navigationsdaten in Echtzeit auf Grundlage des idealen Rasters
bereit und ermÃ¶glicht Schiffen, Booten und autonomen Navigations\-systemen eine
prÃ¤zise Routenplanung in Flachwasserzonen. Die Ergebnisse des Pilotprojekts belegen
die technische Machbarkeit. Das System erÃ¶ffnet darÃ¼ber hinaus neue Perspektiven fÃ¼r
KÃ¼stenmanagement, Umweltmonitoring und Such- und RettungseinsÃ¤tze.
...
\textit{MSC Circular 1023 â€“ Guidelines for Formal Safety Assessment (FSA)},
London, 2002.

\bibitem{imomsccircularnav}
International Maritime Organization (IMO),
\textit{Resolution A.893(21) â€“ Guidelines for Voyage Planning},
London, 1999.
...
% --- Datenkompression und Ãœbertragung ---
\bibitem{sayood2017}
K. Sayood,
