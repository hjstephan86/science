...
% Hyperref configuration with blue links
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
    filecolor=blue,
    ...
    citecolor=blue,
    bookmarksopen=true,
    pdftitle={Lichtgeschwindigkeit in verschiedenen Medien},
    pdfauthor={Stephan Epp},
    pdfsubject={Formale Analyse der Abweichungen und Verteilungen}
}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{./plots/plot1_refractive_index.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{./plots/plot2_speed_deviation.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{./plots/plot3_deviation_analysis.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{./plots/plot4_cdf.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{./plots/plot5_dispersion.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{./plots/plot6_statistics.pdf}
