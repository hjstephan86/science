...
\begin{table}[H]
  \centering
  \caption{Erwartete Präzisionsverbesserungen Phase~1 â†’ Phase~2}
  \label{tab:precision}
  \begin{tabular}{lcc}
    \toprule
...
\bibitem{eppsubgraph2026}
  S. Epp, 
  \textit{Der Subgraph Algorithmus}. Januar 2026, Verfügbar auf \url{https://github.com/hjstephan86/subgraph}
