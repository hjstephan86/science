...
\begin{description}[leftmargin=2cm, style=nextline]
  \item[Sicherheitsziele (Safety Goals):] Oberste Anforderungen auf Fahrzeugebene,
    direkt aus der GefÃ¤hrdungs- und Risikoanalyse (HARA) abgeleitet.
...
unabh\"angigen SicherheitsprÃ¼fer (Functional Safety Assessor) bewertet und
best\"atigt werden.
...
auf \emph{Wissen}, KNN-Training erzeugt \emph{Empirie}. Wissen ist Ã¼bertragbar,
...
\begin{enumerate}[itemsep=4pt]
  ...
  \item \textbf{Werkzeugkettenqualifikation:} Wer KNNs trotz der genannten
    ...
    h\"aufig unterschÃ¤tzt wird und in die Kosten-Nutzen-Bewertung einzubeziehen ist.
\end{enumerate}
...
\bibitem{EUAI2019}
High-Level Expert Group on AI (EuropÃ¤ische Kommission):
\textit{Ethics Guidelines for Trustworthy AI}.
BrÃ¼ssel: EuropÃ¤ische Kommission, 2019.
