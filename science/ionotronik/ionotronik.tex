...
wÃ¤ssrige L\"osung vollst\"andig dissoziierten Salzes.
...
Im ionotronischen Betrieb wÃ¤hlen wir $c_{\mathrm{logic}} = 0{,}1\,\mathrm{mol/L}
...
Modelliere den ionischen Kanal als GauÃŸ'schen Kanal mit Signal $c \in [0, c_{\max}]$
...
SynapsenstÃ¤rke $w_{ij}$ $\leftrightarrow$ Kanal-LeitfÃ¤higkeit $\kappa_{ij}$.
...
Ionotronische Verschl\"usselung: SchlÃ¼ssel $K$ ist das Konzentrationsprofil
...
Einzel-Ionen-Tunneln, diskrete Leitf\"ahigkeitssprÃ¼nge.
