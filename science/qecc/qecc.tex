...
Subgraph Algorithmus~\cite{epp2026subgraph}:
\begin{itemize}
    \item \textbf{Fehlersyndrom als Graph:} Das Muster ausgelÃ¶ster
...
\textbf{Schritt 2: OrthogonalitÃ¤tsbedingung $C_2 \subseteq C_1$.}
...
des resultierenden CSS-Codes betr\"agt $d$ (BlocklÃ¤nge der Komponentencodes).
\end{proof}
...
F\"ur festes $L$ (Bibliotheksgr\"o{\ss}e wÃ¤chst nicht mit $n$): $O(n^3)$.
\end{proof}
