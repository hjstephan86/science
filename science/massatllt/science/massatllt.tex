...
Abschnitt~\ref{sec:foundations} legt die mathematischen Grundlagen (Agenten, MAS, Trajektoriendefinitionen). Abschnitt~\ref{sec:trajectory} definiert die Drosophila-Trajektorie und ihre Lemniskatenform formal. Abschnitt~\ref{sec:energy} entwickelt das Energiemodell mit Fahrtwind-Induktionsfedern. Abschnitt~\ref{sec:cfta} entwickelt das MAS-Koalitionsmodell fÃ¼r LEO-Satelliten und die zugehÃ¶rige Koalitionsbildungsstrategie. Abschnitt~\ref{sec:subgraph} fÃ¼hrt die polynomielle Reduktion auf den Subgraph Algorithmus durch. Abschnitt~\ref{sec:lsat} beschreibt das LSAT-Entscheidungsverfahren. Abschnitt~\ref{sec:simulation} prÃ¤sentiert Simulation und experimentelle Ergebnisse mit matplotlib-Visualisierungen. Abschnitt~\ref{sec:outlook} gibt einen sehr ausfÃ¼hrlichen Ausblick. Die Zusammenfassung schlieÃŸt die Arbeit ab.
...
\subsection{Skalierung des MAS auf groÃŸe Konstellationen}
...
\bibitem{Epp2026lsat}
Epp, S. (2026).
\textit{Learning SAT in Boolean Circuits}. VerfÃ¼gbar auf
\url{https://github.com/hjstephan86/science/tree/main/science/lsat}.

\bibitem{EppSigChiffre}
Epp, S. (2026).
\textit{Eine strukturbasierte VerschlÃ¼sselungsmethode auf Basis der injektiven Subgraph-Signaturfunktion}. VerfÃ¼gbar auf
\url{https://github.com/hjstephan86/science/tree/main/science/sigchiffre}.

\bibitem{EppEHAE}
Epp, S. (2026).
\textit{EtherCAT Protocol Erweiterung}.  VerfÃ¼gbar auf
\url{https://github.com/hjstephan86/science/tree/main/science/ethercate}.
