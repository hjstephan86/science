...
wird unterhalb von 26{,}5\,Â°C zu gering f\"{u}r eine selbsttragende
Zyklonenentwicklung.
...
Monte-Carlo-Ensemble-Simulationen mit gestÃ¶rten Anfangsbedingungen
...
\begin{itemize}
    ...
    \item ZielhÃ¶hen $1000$--$5000\;\mathrm{m}$ MSL
          in Windverh\"{a}ltnissen bis $>30\;\mathrm{m\,s}^{-1}$
    \item Zeitliche Z\"{u}ndprÃ¤zision $<1\;\mathrm{s}$
\end{itemize}
