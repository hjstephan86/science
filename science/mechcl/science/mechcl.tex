...
\begin{definition}[Systemzustände]
  ...
  \begin{itemize}[noitemsep]
    ...
    \item $Z_2$: Zweiter Rastzustand â€” vollständig geschlossen (Einrastung auf $E_1 \cup E_2$)
...
Dies bedeutet, dass die Pins auf $E_2$ in ihrer ursprünglichen Winkelposition einrasten â€”
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=1.1]
    ...
    \node[blue!70, font=\bfseries\small] at (0, 4.2) {$E_1$ â€” wird freigegeben};

    % Ebene E2
    \fill[green!15, draw=green!50, rounded corners=3pt] (-4.0, 1.0) rectangle (4.0, 2.0);
    \node[green!70, font=\bfseries\small] at (0, 1.7) {$E_2$ â€” wird freigegeben};
...
\begin{proof}
  ...
  \begin{itemize}
    \item \textit{Axiale Zugkraft} (Abheben): blockiert durch die Rastnasen beider Ebenen;
          Entriegelung erfordert $F_{\text{zug}} > F_{\text{Rast,ges}}$ â€” jedoch löst diese
...
\begin{enumerate}
  ...
  \item \textbf{Eindeutige Entriegelung}: Genau eine physikalische Aktion â€” der axiale
        Zentraldruckimpuls â€” führt zur simultanen Freigabe beider Ebenen (Satz~\ref{thm:einheit}).
\end{enumerate}
